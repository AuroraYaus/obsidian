...
- 配图：`docs/L1/assets/T2.13_cfo_constellation_rotation.svg`、`docs/L1/assets/T2.13_cfo_vs_sfo_phase_slope.svg`、`docs/L1/assets/T2.13_cfo_subcarrier_leakage.svg`.

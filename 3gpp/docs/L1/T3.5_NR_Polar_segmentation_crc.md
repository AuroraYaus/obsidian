...
| TS 38.212 §5.2.1 Polar coding | `TS_36.212_36212-j30_content.md` lines around `## 5.2.1Polar coding`，`document.xml` |
| TS 38.212 §5.3.1 Polar coding | `TS_36.212_36212-j30_content.md` lines around `## 5.3.1Polar coding` |
| TS 38.212 §5.3.1.2 Polar encoding | `TS_36.212_36212-j30_content.md` lines around `## 5.3.1.2Polar encoding`，`tables/table_0012.csv/html` |
| TS 38.212 §5.4.1 Rate matching for Polar code | `TS_36.212_36212-j30_content.md` lines around `## 5.4.1Rate matching for Polar code` |
| TS 38.212 §6.3.1.2.1 | `TS_36.212_36212-j30_content.md` lines around `## 6.3.1.2.1UCI encoded by Polar code` |
| TS 38.212 §6.3.2.2.1 | `TS_36.212_36212-j30_content.md` lines around `## 6.3.2.2.1UCI encoded by Polar code` |
| TS 38.212 §7.3.2 | `TS_36.212_36212-j30_content.md` lines around `## 7.3.2CRC attachment`，`document.xml` |
| TS 38.212 §7.3.3 | `TS_36.212_36212-j30_content.md` lines around `## 7.3.3Channel coding`，`document.xml` |

本节会复现本节实际使用的协议表格子集和教学公式。由于 `TS_36.212_36212-j30_content.md` 对 §5.2.1 的分段公式和若干符号抽取不完整，涉及完整 UCI 分段条件、所有 $E$/$K$/$C$ 判定细节时，会明确标注边界，不把未逐符号核验的内容写成 bit-exact 结论。
...
本地 `TS_36.212_36212-j30_content.md` 对 §6.3.1.2.1 的部分判定公式符号缺失，因此本节不重建完整 UCI 分段判定表。后续 UCI 专章需要结合原始 Word XML、§6.3.1.4.1、§6.3.1.4.3 和 PUSCH 资源公式，把 $A$、$E$、$C$ 与 6/11 bit CRC 的完整条件逐项复现。
...
| 对象 | 定点关注点 | 工程建议 |
|:---|:---|:---|
| 输入 LLR | 符号约定、位宽、饱和、缩放 | 复用 T2.5 的 LLR 量化规则，单独统计控制信道饱和率。 |
...
- `TS_36.212_36212-j30_content.md` 与 `sections.jsonl`：§5.2.1、§5.3.1、§5.3.1.2、§5.4.1、§6.3.1.2.1、§6.3.2.2.1、§7.3.2、§7.3.3 的章节定位。
- `TS_36.212_36212-j30_content.md` lines around §7.3.2：DCI 24 bit CRC 和 RNTI 加扰文本。

边界说明：

- 本节不重建完整 TS 38.212 Table 5.3.1.2-1 的 1024 项序列；后续 NR Polar reliability sequence 专章需要完整复现或表格化。
- 本节不重建 §5.2.1 的所有 code block segmentation 公式，因为当前 `TS_36.212_36212-j30_content.md` 对公式符号抽取缺失，需结合原始 Word XML/OMML 再做 bit-exact 讲解。
...
| TS 38.212 §7.3.2 | 已核对 `TS_36.212_36212-j30_content.md`/`document.xml` | DCI 使用 24 bit CRC，CRC parity bits 用对应 RNTI 加扰。 |
| TS 38.212 §7.3.3 | 已核对 `TS_36.212_36212-j30_content.md`/`document.xml` | DCI CRC 后进入 Polar coding。 |
## 执行与证据记录

| 项目 | 记录 |
|:---|:---|
| 本地协议检索 | 使用 `rg`、`sed` 检索 TS 38.212 `TS_36.212_36212-j30_content.md`、`sections.jsonl`、`document.xml` 和 `tables/*.csv/html`。 |

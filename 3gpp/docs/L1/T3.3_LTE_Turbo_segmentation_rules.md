...
| 表格核验 | 查看 `tables/table_0009.csv` 和 `tables/table_0009.html`，确认 Turbo 合法 $K$ 集合和 $f_1/f_2$ 参数可由本地表格抽取；使用 `pdftoppm` 从 `source.pdf` 第 16 页提取协议原文截图，替换原有生成图表，保存为 `docs/L1/assets/T3.3_TS36.212_Table_5.1.3-3.png`。 |

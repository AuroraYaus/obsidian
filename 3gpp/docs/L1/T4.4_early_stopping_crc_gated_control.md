...
tags:
  ...
  - l1
  - lesson
source_spec: "docs/L1/T4.4_early_stopping_crc_gated_control.md"
---
...
| TS 36.212 Rel-19 `36212-j30` §5.1.2 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md` |
| TS 36.212 Rel-19 `36212-j30` §5.1.3.2、§5.2.2、§5.3.2 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md` |
| TS 38.212 Rel-19 `38212-j30` §5.1、§5.2.2、§5.3.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` |
| TS 38.212 Rel-19 `38212-j30` §6.2.1、§6.2.3、§7.2.1、§7.2.3 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` |
| TS 38.212 Rel-19 `38212-j30` §5.2.1、§5.3.1、§7.3.2、§8.3.2、§8.4.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` |
| TS 38.214 Rel-19 `38214-j30` §5.1、§5.1.3、§6.1.4 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md` |
...
| 资料 | 边界 |
| :--- | :--- |
| T3.1 LTE/NR CRC 家族 | 本节不重新复现 LTE/NR CRC 多项式表。 |
| T4.1 迭代译码与外信息 | 本节不推导 Turbo MAP 或完整 LDPC BP。 |
| T4.3 HARQ 软合并基础 | 本节不复现 RV 和 soft combining 详细规则。 |
...
- 关系语义：本节把 CRC/syndrome/path metric 作为实现级停止条件，连接到后续三类编码的译码器控制。

## 协议证据表

| 证据 | 本地路径 | 状态 | 本节结论 |
|:---|:---|:---|:---|
| TS 36.212 Rel-19 `36212-j30` §5.1.1 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md`，`sections.jsonl` | 已定位 | LTE CRC calculation 是 CRC checker 的协议锚点。 |
| TS 36.212 Rel-19 `36212-j30` §5.1.2 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md`，`sections.jsonl` | 已定位 | LTE CB segmentation 和 CB CRC 决定 Turbo 早停检查对象。 |
| TS 36.212 Rel-19 `36212-j30` §5.1.3.2、§5.2.2、§5.3.2 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md`，`sections.jsonl` | 已定位 | LTE Turbo 编码结构和 UL/DL transport channel 链路是 Turbo 译码控制背景。 |
| TS 38.212 Rel-19 `38212-j30` §5.1、§5.2.2、§5.3.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md`，`sections.jsonl` | 已定位 | NR CRC、LDPC segmentation 和 LDPC coding 是 LDPC syndrome/CRC 停止的结构锚点。 |
| TS 38.212 Rel-19 `38212-j30` §6.2.1、§6.2.3、§7.2.1、§7.2.3 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md`，`sections.jsonl` | 已定位 | NR UL-SCH/DL-SCH 的 TB CRC 和 CB CRC 决定最终验收边界。 |
| TS 38.212 Rel-19 `38212-j30` §5.2.1、§5.3.1、§7.3.2、§8.3.2、§8.4.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md`，`sections.jsonl` | 已定位 | NR Polar 和 DCI/UCI CRC attachment 是 CRC 辅助路径选择的协议背景。 |
| TS 38.214 Rel-19 `38214-j30` §5.1、§5.1.3、§6.1.4 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md`，`sections.jsonl` | 已定位 | HARQ process、MCS/TBS/RV 是停止结果进入系统控制的 descriptor 背景。 |
## 执行与证据记录

| 项目 | 记录 |
|:---|:---|
| 总纲复核 | 已读取 `合规与遵从.md` 的 Skill Management、Hard Constraints、Document & Code Formatting Standards 和单节讲义结构要求。 |
| 路线图依据 | 已读取 `2026-06-19-lte-nr-decoding-learning-roadmap.md` 中 T4.4 卡片，覆盖 Turbo CRC 门控、LDPC syndrome/CRC、Polar CRC 辅助路径选择和 CRC 误通过案例。 |
| 风格依据 | 已读取 `docs/L1/T4.1_iterative_decoding_extrinsic_information.md`、`docs/L1/T4.3_HARQ_soft_combining_basics.md`、`docs/L1/T3.1_LTE_NR_CRC_families.md` 的标题、术语、证据表和执行记录格式。 |
| 本地协议检索 | 使用 `rg`/`sed` 检索 TS 36.212、TS 38.212、TS 38.214 的 `TS_36.212_36212-j30_content.md`，定位 CRC、CB segmentation、Turbo/LDPC/Polar coding、DCI/UCI CRC 和 HARQ/MCS/TBS 入口。 |
...
| 证据边界 | 本节只读取 `TS_36.212_36212-j30_content.md` 和相关文档目录元信息，未核验 TS 38.212 表格 HTML、公式 XML 或 Word 原图；因此不声明完整复现协议表格、图或公式。 |
| 审计结果 | `python3 tools/audit_lesson_terms.py docs/L1/T4.4_early_stopping_crc_gated_control.md`：`LESSON_TERM_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_markdown_headings.py docs/L1/T4.4_early_stopping_crc_gated_control.md`：`MARKDOWN_HEADING_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_lesson_depth.py --strict docs/L1/T4.4_early_stopping_crc_gated_control.md`：`LESSON_DEPTH_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_latex_render.py docs/L1/T4.4_early_stopping_crc_gated_control.md`：`LATEX_RENDER_AUDIT_OK formulas=18`。 |
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L1/T4.4_early_stopping_crc_gated_control.md` 返回 `REFERENCE_REBUILD_AUDIT_CANDIDATES`，退出码为 0；候选为本节自写教学公式、已标注待核验边界和未在本节复现的协议表/图范围。 |

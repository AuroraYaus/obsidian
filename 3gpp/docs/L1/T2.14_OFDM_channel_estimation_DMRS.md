...
| 图解材料 | 新增三张手绘 SVG：`docs/L1/assets/T2.14_dmrs_grid_mapping.svg`、`T2.14_ls_estimation_interpolation.svg`、`T2.14_channel_estimation_error_constellation.svg`；保留 Markdown 内嵌 Mermaid 概念图。 |

...
| [[T2.14_QAM_Max_Log_MAP_demapping]] QAM 软解调 | 知道均匀先验 LLR 公式（式 (10)）与 Max-Log-MAP 近似——本章要打破它的"星座等概率"假设。 |
| [[T2.9_AWGN_noise_scaling]] AWGN 噪声缩放 | 知道 $\sigma^2$ 的口径（每维噪声功率）与归一化星座约定——$\tilde\nu\sigma^2$ 正则的量纲依据。 |

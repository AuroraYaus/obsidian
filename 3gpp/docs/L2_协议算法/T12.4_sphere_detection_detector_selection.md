...
| [[T12.3_linear_detectors_mf_zf_mmse]] | 知道 MMSE 是线性默认（约 100 MACs（乘加运算，Multiply-Accumulate operations）/tone、约 95K gates、约 20 cycles/tone、1–3 dB 损失）；本节把 Sphere 作为它的最优参照。 |

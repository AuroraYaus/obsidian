...
| 死链检查 | 全部 wiki 内链目标存在（T13.1–T13.3、T8.1、T9.1、T12.1、T2.14、概念笔记 SBPM/Selective_Scrambling/PAS/Probabilistic_Shaping 等）；T13.5–T13.6 未创建，正文一律用"第 5 章将……"文字承接、无链接。 |

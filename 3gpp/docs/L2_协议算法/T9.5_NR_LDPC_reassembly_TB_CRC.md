...
3. 本项目 T3.1：`docs/L1_基础/T3.1_LTE_NR_CRC_families.md`。
4. 本项目 T3.4：`docs/L1_基础/T3.4_NR_LDPC_segmentation_rules.md`。
5. 本项目 T8.1：`docs/L2_协议算法/T8.1_NR_LDPC_decoder_chain_overview.md`。

...
- 本节是总览。[[T9.2_NR_LDPC_circular_buffer_states|T9.2]] 会专门展开 puncturing、shortening、repetition；[[T9.3_NR_LDPC_HARQ_soft_buffer_RV_k0|T9.3]] 会专门展开 HARQ soft buffer、RV 和CBG。

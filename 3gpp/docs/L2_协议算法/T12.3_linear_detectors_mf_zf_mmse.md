...
|:---|:---|:---|:---|:---|
| 每 RE 运算 | 无求逆，约 $N_{\mathrm{rx}}N_{\mathrm{layers}}$ MAC | 一次 $N_{\mathrm{layers}}\times N_{\mathrm{layers}}$ 求逆，$O(N_{\mathrm{layers}}^3)$ | 同 ZF | 100–1000 MACs（乘累加操作，Multiply-Accumulate operations）/tone 量级，低 SNR 爆炸 |

...
| 新增证据资产 | `docs/L0_协议阅读引导/assets/T0.1_LTE_NR_decoder_protocol_reading_map.svg`（手绘 SVG，替代原 Mermaid 渲染 PNG 及 `tools/figures/render_t0_1_lte_nr_decoder_protocol_map.py`）。 |

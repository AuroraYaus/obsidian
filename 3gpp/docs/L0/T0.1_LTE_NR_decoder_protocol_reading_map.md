...
| TS 36.211/38.211 | `3GPP_Rel19/processed/TS_36.211_*`，`TS_38.211_38211-j30` | 调制和物理映射背景。T2.1–T2.6 提供 OFDM 原理、Numerology、帧结构、资源网格（RE/PRB/CRB/Point A/BWP）、LTE 对比和 LLR 数据流的系统入口。 |
...
```text
T2.1-T2.6 PHY 系统背景 → T1-T5 译码数学与工程基础
...
## 图示
![图 1：LTE NR decoder protocol reading map](assets/T0.1_LTE_NR_decoder_protocol_reading_map.png)
...
| 新增证据资产 | `docs/L0/assets/T0.1_LTE_NR_decoder_protocol_reading_map.png`。 |

...
| T7.3/T7.6 | `docs/L2_协议算法/T7.3_LTE_HARQ_soft_buffer_RV.md`、`docs/L2_协议算法/T7.6_LTE_Turbo_decoder_edge_cases.md` | 本节只把它们转成覆盖点。 |
| T9.3/T9.6 | `docs/L2_协议算法/T9.3_NR_LDPC_HARQ_soft_buffer_RV_k0.md`、`docs/L2_协议算法/T9.6_NR_LDPC_decoder_edge_cases.md` | 本节不重写 LDPC 数值推导。 |
| T10.5-T10.8 | `docs/L2_协议算法/T10.*.md` | 本节不重写 Polar SCL 推导。 |
| T20.1/T20.2 | `docs/L3_工程实现/T20.1_decoder_testbench_architecture.md`、`docs/L3_工程实现/T20.2_protocol_vector_corner_case_suite.md` | 本节将其组织成 coverage/regression plan。 |
...
| :--- | :--- | :--- |
| LTE Turbo segmentation/filler/RV/CRC | TS 36.212 Rel-19 `36212-j30`；T3.3/T7.3/T7.6 | `3GPP_Rel19/processed/TS_36.212_36212-j30`；`docs/L2_协议算法/T7.*.md` |
...
| Directed vector suite | T20.2 | `docs/L3_工程实现/T20.2_protocol_vector_corner_case_suite.md` |
| Testbench observability | T20.1 | `docs/L3_工程实现/T20.1_decoder_testbench_architecture.md` |
...
| 项目 | 证据 |
|:---|:---|
| 图形资产 | `docs/L3_工程实现/assets/T15.3_coverage_regression_strategy.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t15_3_coverage_regression_strategy.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |

...
## 图示
![图 1：NR Polar float sim flow](assets/T12.4_NR_Polar_float_sim_flow.svg)
...
| 新增证据资产 | `docs/L3_工程实现/assets/T12.4_NR_Polar_float_sim_flow.svg`（手绘 SVG，替代原 PIL 渲染 PNG 及 `tools/figures/render_t12_4_nr_polar_float_sim_flow.py`）。 |

...
- `docs/L3_工程实现/assets/T19.1_LTE_Turbo_RTL_microarchitecture.svg`（手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG；原 `tools/figures/render_t14_1_lte_turbo_rtl_microarchitecture.py` 与 `T14.1_LTE_Turbo_RTL_microarchitecture.png` 已删除，图示语义与数据不变）

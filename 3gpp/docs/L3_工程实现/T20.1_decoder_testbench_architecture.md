...
| 图形资产 | `docs/L3_工程实现/assets/T15.1_decoder_testbench_architecture.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t15_1_decoder_testbench_architecture.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |

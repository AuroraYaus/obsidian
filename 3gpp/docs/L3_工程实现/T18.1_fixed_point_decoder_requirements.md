...
| 上游讲义 | 已读取 `docs/L1_基础/T2.11_LLR_clipping_scaling_quantization.md`、`docs/L1_基础/T5.1_fixed_point_numbers_for_LLR.md`、`docs/L3_工程实现/T17.1_python_golden_model_project_layout.md`。 |
...
- [上游讲义] `docs/L1_基础/T2.11_LLR_clipping_scaling_quantization.md`，LLR 裁剪、缩放与量化预览。

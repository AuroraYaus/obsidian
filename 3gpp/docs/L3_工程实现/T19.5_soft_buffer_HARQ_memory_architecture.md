...
## 图示
![图 1：soft buffer HARQ memory architecture](assets/T19.5_soft_buffer_HARQ_memory_architecture.svg)
...
| 图形资产 | `docs/L3_工程实现/assets/T19.5_soft_buffer_HARQ_memory_architecture.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t14_5_soft_buffer_harq_memory.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |

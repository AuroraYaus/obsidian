...
| Testbench 架构 | `docs/L3_工程实现/T20.1_decoder_testbench_architecture.md` | T20.2 输出给 T20.1 消费。 |
...
| vector schema、checkpoint manifest、failure bundle 属于工程回归框架。 | 项目 T18.6、T20.1。 | `docs/L3_工程实现/T18.6_bit_exact_regression_harness.md`、`docs/L3_工程实现/T20.1_decoder_testbench_architecture.md` | 不属于 3GPP 强制流程。 |
...
| 图形资产 | `docs/L3_工程实现/assets/T15.2_protocol_vector_corner_case_suite.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t15_2_protocol_vector_corner_case_suite.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |
...
- [Project, 2026] T20.1 Decoder SystemVerilog testbench architecture, `docs/L3_工程实现/T20.1_decoder_testbench_architecture.md`.

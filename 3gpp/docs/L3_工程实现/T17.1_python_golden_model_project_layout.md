...
| 新增证据资产 | `docs/L3_工程实现/assets/T17.1_golden_model_project_layout.svg`（手绘 SVG，替代原 PIL 渲染 PNG 及 `tools/archive_python_drawing/figures/render_t12_1_golden_model_layout.py`）。 |

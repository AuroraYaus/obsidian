...
| 结论 | 协议证据 | 本地核验 |
|:---|:---|:---|
| NR LDPC 的 $H$ 由 BG、$Z_c$ 和 shift table 构造 | TS 38.212 §5.3.2 | `content.md` 行 948-989；T8.3 已重建 Table 5.3.2-1/2/3。 |
| LDPC 编码在 GF(2) 中执行 | TS 38.212 §5.3.2 | `content.md` 行 948-989；T8.4 已用 syndrome 手算解释。 |
...
## 图示
![图 1：LDPC BP SPA one round](assets/T8.5_LDPC_BP_SPA_one_round.png)

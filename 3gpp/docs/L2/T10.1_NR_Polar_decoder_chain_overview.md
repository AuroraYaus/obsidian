...
tags:
  ...
  - l2
  - lesson
source_spec: "docs/L2/T10.1_NR_Polar_decoder_chain_overview.md"
---
...
| TS 38.212 §5.2.1 | `TS_36.212_36212-j30_content.md:665-715` |
| TS 38.212 §5.3.1 | `TS_36.212_36212-j30_content.md:815-837` |
| TS 38.212 §5.3.1.1 | `TS_36.212_36212-j30_content.md:839-871`；`tables/table_0011.csv/html` |
| TS 38.212 §5.3.1.2 | `TS_36.212_36212-j30_content.md:873-883`；`tables/table_0012.csv/html` |
| TS 38.212 §5.4.1 | `TS_36.212_36212-j30_content.md:1019-1125` |
| TS 38.212 §6.3.1.2.1/§6.3.1.3.1/§6.3.1.4.1 | `TS_36.212_36212-j30_content.md:2321-2387` |
| TS 38.212 §6.3.2.2.1/§6.3.2.3.1/§6.3.2.4.1 | `TS_36.212_36212-j30_content.md` 中 §6.3.2 对应章节 |
| TS 38.212 §7.3.2-§7.3.4 | `TS_36.212_36212-j30_content.md:7177-7207` |

证据边界：`TS_36.212_36212-j30_content.md` 对若干公式符号抽取不完整，因此本节不声称复现了 §5.2.1、§5.3.1、§5.4.1 的全部 bit-exact 公式。涉及完整可靠性序列、sub-block interleaver pattern、puncturing/shortening/repetition 索引和 CA-SCL 路径度量时，分别由 T10.3、T10.7、T10.4-T10.6 复现和推导。
...
本节不规定具体位宽。T13.4 会规划 NR Polar 定点模型，T14.3 会规划 RTL 微架构；本节只要求 descriptor 和日志字段足够支持 bit-exact 对比。
...
Polar 硬件瓶颈通常不在一个大矩阵乘法，而在树遍历控制、路径复制、排序、partial-sum 访问和低延迟 selector。T10.5/T10.6/T14.3 会继续细化。
...
- 关系语义：本节把 Polar 控制链路的 CRC、LLR、rate recovery、SCL 译码和最终验收边界连起来。
...
| Polar 分段和 CRC attachment 是通用入口 | TS 38.212 §5.2.1 | `TS_36.212_36212-j30_content.md:665-715` |
| Polar channel coding 调用 §5.3.1 | TS 38.212 §5.3.1 | `TS_36.212_36212-j30_content.md:815-837` |
| Polar sequence 按可靠性升序排列 | TS 38.212 §5.3.1.2 | `TS_36.212_36212-j30_content.md:873-883`；`tables/table_0012.csv/html` |
| Polar rate matching 包含 sub-block interleaving、bit collection/selection 和 coded-bit interleaving | TS 38.212 §5.4.1 | `TS_36.212_36212-j30_content.md:1019-1125` |
| PUCCH UCI Polar 分支调用 §5.2.1、§5.3.1、§5.4.1 | TS 38.212 §6.3.1.2.1、§6.3.1.3.1、§6.3.1.4.1 | `TS_36.212_36212-j30_content.md:2321-2387` |
| DCI 使用 24 bit CRC、RNTI 边界、Polar coding 和 rate matching | TS 38.212 §7.3.2-§7.3.4 | `TS_36.212_36212-j30_content.md:7177-7207` |
## 执行与证据记录

| 项 | 记录 |
|:---|:---|
| 写作范围 | 新增 `docs/L2/T10.1_NR_Polar_decoder_chain_overview.md`。 |
...
| 自动审计 | `python3 tools/audit_lesson_terms.py docs/L2/T10.1_NR_Polar_decoder_chain_overview.md` 输出 `LESSON_TERM_AUDIT_OK`；`python3 tools/audit_markdown_headings.py docs/L2/T10.1_NR_Polar_decoder_chain_overview.md` 输出 `MARKDOWN_HEADING_AUDIT_OK`；`python3 tools/audit_lesson_depth.py --strict docs/L2/T10.1_NR_Polar_decoder_chain_overview.md` 输出 `LESSON_DEPTH_AUDIT_OK`；`python3 tools/audit_latex_render.py docs/L2/T10.1_NR_Polar_decoder_chain_overview.md` 输出 `LATEX_RENDER_AUDIT_OK formulas=30`。 |
| 审核经理 | 待审核。 |
...
4. 本项目 T4.2：`docs/L1/T4.2_graphs_trellises_trees_for_decoding.md`。

...
| T2.11 LLR 量化 | 知道 LLR 可以裁剪、缩放、量化，重复累加时必须考虑饱和。 |
...
本节不复现 Table 5.4.2.1-2 的具体起点数值，因为本地 `content.md` 的公式符号抽取不完整。后续若 T9.3 要使用具体 RV 起点表，会先从 `source.docx`、表格 HTML/CSV 或 Word XML 重建表格，再写入正文。
...
| bit interleaving 与 $Q_m$ 相关 | TS 38.212 Rel-19 §5.4.2.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md:1311-1323` | 已核验语义，详细索引后续 T9.2 展开。 |
| UL-SCH 逐 CB 调用 §5.4.2，limited-buffer rate matching 影响 `ILBRM` | TS 38.212 Rel-19 §6.2.5 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md:1397-1407` | 已核验语义。 |
| DL-SCH/PCH 逐 CB 调用 §5.4.2 | TS 38.212 Rel-19 §7.2.5 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md:3771-3775` | 已核验。 |
| PDSCH 的 $Q_m$、RV、TBS 来自调度流程 | TS 38.214 Rel-19 §5.1.3 | `3GPP_Rel19/processed/TS_38.214_38214-j30/content.md:1157-1167` | 已核验。 |
...
## 图示
![图 1：NR LDPC rate recovery overview](assets/T9.1_NR_LDPC_rate_recovery_overview.png)

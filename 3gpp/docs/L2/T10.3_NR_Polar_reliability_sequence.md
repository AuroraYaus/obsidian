...
| 协议位置 | 本地证据路径 |
| :--- | :--- |
| TS 38.212 §5.3.1.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:873-883` |
| TS 38.212 Table 5.3.1.2-1 | `tables/table_0012.csv/html` |
| TS 38.212 §5.4.1.1 | `TS_36.212_36212-j30_content.md:1041-1079` |
...
| 结论 | 协议依据 | 本地证据 |
|:---|:---|:---|
| Polar sequence 按可靠性升序排列 | TS 38.212 §5.3.1.2 | `TS_36.212_36212-j30_content.md:873-879` |
| Table 5.3.1.2-1 给出 1024 项 Polar sequence | TS 38.212 Table 5.3.1.2-1 | `tables/table_0012.csv/html`；图 T10.3-1 |
| 编码在 GF(2) 中执行 | TS 38.212 §5.3.1.2 | `TS_36.212_36212-j30_content.md:941-943` |
| information/frozen 集合还与 §5.4.1.1 中集合有关 | TS 38.212 §5.3.1.2/§5.4.1.1 | `TS_36.212_36212-j30_content.md:879-883`; `TS_36.212_36212-j30_content.md:1041-1079` |
## 执行与证据记录

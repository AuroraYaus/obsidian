...
TS 36.212 Rel-19 §5.1.3 说明不同传输信道和控制信息类型使用的编码方案由 Table 5.1.3-1 和 Table 5.1.3-2 给出。`TS_36.212_36212-j30_content.md` 行 693-705 给出表格入口；行 719-723 进入 Turbo coding，并说明 Turbo encoder 是并行级联卷积码，包含两个 8-state constituent encoders 和一个内部交织器，码率为 1/3。

本地 `tables/table_0007.csv` 抽取如下。原 Word 表存在合并单元格，CSV 中空白单元格表示继承原表合并单元格语义；使用时以 `table_0007.html` 和 `TS_36.212_36212-j30_content.md` 交叉核验。
...
容量和编码增益也要按同一口径比较。Turbo、LDPC、Polar 的曲线若使用不同块长、码率、调制、SNR 定义或停止条件，就不能直接比较“谁离容量更近”。T1.6 提供容量和容量差距语言，T4.5/T12.5 负责把瀑布区、错误平层和置信区间写进报告。
...
| 结论 | 协议证据 | 本地路径 |
|:---|:---|:---|
| LTE TrCH 编码方案表给出 Turbo coding 用于 UL-SCH、DL-SCH、PCH、MCH、SL-SCH、SL-DCH 等，BCH/SL-BCH 为 tail biting convolutional coding。 | TS 36.212 Rel-19 `36212-j30` §5.1.3, Table 5.1.3-1。 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md:693-705`; `tables/table_0007.csv/html`。 |
| LTE Turbo encoder 是 PCCC，含两个 8-state constituent encoders 和一个 turbo code internal interleaver，码率 1/3。 | TS 36.212 §5.1.3.2.1。 | `TS_36.212_36212-j30_content.md:719-723`。 |
| LTE 控制信息不是本节 Polar 对比主线。 | TS 36.212 Table 5.1.3-2。 | `tables/table_0008.csv/html`。 |
| NR TrCH 编码方案表给出 UL-SCH/DL-SCH/PCH 使用 LDPC，BCH 使用 Polar code。 | TS 38.212 Rel-19 `38212-j30` §5.3, Table 5.3-1。 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:807-813`; `tables/table_0009.csv/html`。 |
| NR 控制信息表给出 DCI 使用 Polar code，UCI 可使用 block code 或 Polar code。 | TS 38.212 §5.3, Table 5.3-2。 | `TS_36.212_36212-j30_content.md:807-813`; `tables/table_0010.csv/html`。 |
| NR DCI 使用 CRC、RNTI 处理、Polar coding 和 Polar rate matching。 | TS 38.212 §7.3.2-§7.3.4。 | `TS_36.212_36212-j30_content.md:7177-7207`。 |
| NR UCI Polar 分支存在 6/11 bit CRC 和 Polar coding 调用边界。 | TS 38.212 §6.3.1.2.1, §6.3.1.3.1。 | `TS_36.212_36212-j30_content.md:2325-2345`。 |
## 执行与证据记录

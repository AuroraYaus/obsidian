...
tags:
  ...
  - l2
  - lesson
source_spec: "docs/L2/T9.5_NR_LDPC_reassembly_TB_CRC.md"
---
...
本节不重新推导 BG、Zc、lifting size 或 LDPC 迭代算法。那些属于 T3.4、T8.2、T8.3、T8.5-T8.8。这里关心的是译码后的比特边界和接收端状态机。
...
| 协议位置 | 本地证据路径 |
| :--- | :--- |
| TS 38.212 §5.2.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:717-805` |
| TS 38.212 §5.5 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:1335-1359` |
| TS 38.212 §6.2.1/§6.2.3/§6.2.6 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:1361-1415` |
| TS 38.212 §7.2.1/§7.2.3/§7.2.6 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:3737-3783` |
| TS 38.214 §5.1.7 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md:2407-2437` |
| TS 38.214 §6.1.5 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md:7099-7125` |
...
对于 PDSCH，若 DCI 中存在 CBGFI，还要按 TS 38.214 §5.1.7.2 判断旧实例是否可合并。`CBGFI=0` 表示早前相同 CBG 实例可能损坏，接收端不能盲目把旧 LLR 当成可合并证据；`CBGFI=1` 表示可与早前实例合并。T9.3 已讲 soft buffer 合并，本节只强调重组时要使用正确的 CB result/status。
...
这种错误很像 T9.4 的 bit order 错误：局部信息很可靠，但被放在错误位置，最终全局 CRC 不可能通过。
...
这个 toy 不实现真实 CRC 多项式。真实 CRC 计算已在 T3.1 复现；本节只验证输入边界和拼接顺序。

## 浮点仿真方案

T9.5 位于硬判决之后，浮点 LLR 本身不是主角，但链路仿真仍要保留从 LLR 到 CRC 的闭环：
...
高信噪比下仍 TB CRC fail 时，优先检查 T9.4 bit deinterleaving、T9.1/T9.3 rate recovery 地址、T9.5 拼接顺序和 CRC 输入边界，而不是立即改 LDPC Min-Sum 参数。
...
| 结论 | 协议依据 | 本地证据 |
|:---|:---|:---|
| UL-SCH transport block 有 TB CRC | TS 38.212 §6.2.1 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:1361-1375` |
| UL-SCH code block segmentation 调用 §5.2.2 | TS 38.212 §6.2.3 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:1381-1387` |
| UL-SCH code block concatenation 调用 §5.5 | TS 38.212 §6.2.6 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:1409-1415` |
| DL-SCH/PCH transport block 有 TB CRC | TS 38.212 §7.2.1 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:3737-3753` |
| DL-SCH/PCH code block segmentation 调用 §5.2.2 | TS 38.212 §7.2.3 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:3757-3763` |
| DL-SCH/PCH code block concatenation 调用 §5.5 | TS 38.212 §7.2.6 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:3777-3783` |
| LDPC 分段时可附加 CB CRC 和 filler | TS 38.212 §5.2.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:717-805` |
| CBG 与 CB 的分组、CBGTI、CBGFI 影响部分重传状态 | TS 38.214 §5.1.7/§6.1.5 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md:2407-2437`；`TS_36.212_36212-j30_content.md:7099-7125` |
## 执行与证据记录

| 项 | 记录 |
|:---|:---|
| 写作范围 | 新增 `docs/L2/T9.5_NR_LDPC_reassembly_TB_CRC.md`。 |
...
3. 本项目 T3.1：`docs/L1/T3.1_LTE_NR_CRC_families.md`。
4. 本项目 T3.4：`docs/L1/T3.4_NR_LDPC_segmentation_rules.md`。
5. 本项目 T8.1：`docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md`。
6. 本项目 T9.3：`docs/L2/T9.3_NR_LDPC_HARQ_soft_buffer_RV_k0.md`。

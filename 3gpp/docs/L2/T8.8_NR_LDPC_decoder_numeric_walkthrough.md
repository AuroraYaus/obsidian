...
tags:
  ...
  - l2
  - lesson
source_spec: "docs/L2/T8.8_NR_LDPC_decoder_numeric_walkthrough.md"
---
# T8.8 NR LDPC 译码数值走读
## 本节学习目标
...
| 讲义文件 | `docs/L2/T8.8_NR_LDPC_decoder_numeric_walkthrough.md`。 |
| 协议来源 | TS 38.212 Rel-19 `38212-j30` §5.3.2；本节 toy $H$ 为教学例子，不是规范 NR 向量。 |
| 图表资产 | `docs/L2/assets/T8.8_LDPC_numeric_walkthrough_part1.svg`、`docs/L2/assets/T8.8_LDPC_numeric_walkthrough_part2.svg` 和兼容合并图 `docs/L2/assets/T8.8_LDPC_numeric_walkthrough.svg`（手绘 SVG，替代原 `tools/figures/render_ldpc_numeric_walkthrough.py` 生成的 PNG）。 |
...
| 单篇审计 | `python3 tools/audit_lesson_terms.py docs/L2/T8.8_NR_LDPC_decoder_numeric_walkthrough.md` 输出 `LESSON_TERM_AUDIT_OK`；`python3 tools/audit_markdown_headings.py docs/L2/T8.8_NR_LDPC_decoder_numeric_walkthrough.md` 输出 `MARKDOWN_HEADING_AUDIT_OK`；`python3 tools/audit_lesson_depth.py --strict docs/L2/T8.8_NR_LDPC_decoder_numeric_walkthrough.md` 输出 `LESSON_DEPTH_AUDIT_OK`；`python3 tools/audit_latex_render.py docs/L2/T8.8_NR_LDPC_decoder_numeric_walkthrough.md` 输出 `LATEX_RENDER_AUDIT_OK formulas=263`。 |

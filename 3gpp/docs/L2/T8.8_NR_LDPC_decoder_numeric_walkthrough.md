...
## 图示
![图 1：LDPC numeric walkthrough](assets/T8.8_LDPC_numeric_walkthrough.png)
![图 2：LDPC numeric walkthrough part1](assets/T8.8_LDPC_numeric_walkthrough_part1.png)
![图 3：LDPC numeric walkthrough part2](assets/T8.8_LDPC_numeric_walkthrough_part2.png)
...
| 图表资产 | `tools/figures/render_ldpc_numeric_walkthrough.py` 生成 `docs/L2/assets/T8.8_LDPC_numeric_walkthrough_part1.png`、`docs/L2/assets/T8.8_LDPC_numeric_walkthrough_part2.png` 和兼容合并图 `docs/L2/assets/T8.8_LDPC_numeric_walkthrough.png`。 |

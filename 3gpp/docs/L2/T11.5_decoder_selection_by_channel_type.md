...
tags:
  ...
  - l2
  - lesson
source_spec: "docs/L2/T11.5_decoder_selection_by_channel_type.md"
---
# T11.5 按信道和信息类型选择译码器
## 本节学习目标
...
| 协议位置 | 本地证据路径 |
| :--- | :--- |
| TS 36.212 §5.1.3 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md:683-705` |
...
| TS 36.212 §5.2.2.3 | `TS_36.212_36212-j30_content.md:1093-1101` |
| TS 36.212 §5.3.3.2-§5.3.3.4 | `TS_36.212_36212-j30_content.md:5551-5581` |
...
| TS 38.212 §6.2.4 | `TS_36.212_36212-j30_content.md:1391-1401` |
| TS 38.212 §6.3.1/§6.3.2 | `TS_36.212_36212-j30_content.md:2035-2105`; `TS_36.212_36212-j30_content.md:2863-2889` |
| TS 38.212 §7.3.2-§7.3.4 | `TS_36.212_36212-j30_content.md:7177-7203` |
...
| 结论 | 协议证据 | 本地路径 | 证据状态 |
|:---|:---|:---|:---|
| LTE TrCH 编码方案由 Table 5.1.3-1 给出，DL-SCH/UL-SCH 使用 Turbo | TS 36.212 §5.1.3, Table 5.1.3-1 | `3GPP_Rel19/processed/TS_36.212_36212-j30/TS_36.212_36212-j30_content.md:683-705`; `tables/table_0007.csv/html` | 已核验；T11.1 已复现表格语义，本节复用。 |
| LTE UL-SCH code block individually turbo encoded | TS 36.212 §5.2.2.3 | `TS_36.212_36212-j30_content.md:1093-1101` | 已核验文本。 |
| LTE DCI 是 CRC/RNTI + TBCC + rate matching 分支 | TS 36.212 §5.3.3.2-§5.3.3.4 | `TS_36.212_36212-j30_content.md:5551-5581` | 已核验文本；本节不展开 LTE 控制译码公式。 |
| NR TrCH 编码方案由 Table 5.3-1 给出，DL-SCH/UL-SCH/PCH 使用 LDPC，BCH 使用 Polar | TS 38.212 §5.3, Table 5.3-1 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md:807-813`; `tables/table_0009.csv/html` | 已核验；T11.1 已复现表格语义，本节复用。 |
| NR 控制信息编码方案由 Table 5.3-2 给出，DCI 使用 Polar，UCI 使用 Block code / Polar | TS 38.212 §5.3, Table 5.3-2 | `TS_36.212_36212-j30_content.md:807-813`; `tables/table_0010.csv/html` | 已核验；T11.1 已复现表格语义，本节复用。 |
| NR UL-SCH code block individually LDPC encoded | TS 38.212 §6.2.4 | `TS_36.212_36212-j30_content.md:1391-1401` | 已核验文本。 |
| NR UCI 分 PUCCH/PUSCH 背景 | TS 38.212 §6.3.1/§6.3.2 | `TS_36.212_36212-j30_content.md:2035-2105`; `TS_36.212_36212-j30_content.md:2863-2889` | 已核验文本；small-block/Polar 详细条件由 T10.1/T10.8 承接。 |
| NR DCI 使用 CRC/RNTI、Polar coding 和 rate matching | TS 38.212 §7.3.2-§7.3.4 | `TS_36.212_36212-j30_content.md:7177-7203` | 已核验文本。 |
## 执行与证据记录
...
| 审计命令 | `python3 tools/audit_lesson_terms.py docs/L2/T11.5_decoder_selection_by_channel_type.md`；`python3 tools/audit_markdown_headings.py docs/L2/T11.5_decoder_selection_by_channel_type.md`；`python3 tools/audit_lesson_depth.py --strict docs/L2/T11.5_decoder_selection_by_channel_type.md`；`python3 tools/audit_latex_render.py docs/L2/T11.5_decoder_selection_by_channel_type.md`；`python3 tools/audit_reference_rebuilds.py docs/L2/T11.5_decoder_selection_by_channel_type.md`。 |
...
- `docs/L2/T11.3_HARQ_soft_buffer_comparison.md`。

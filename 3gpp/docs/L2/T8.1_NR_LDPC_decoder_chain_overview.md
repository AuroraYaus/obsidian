...
tags:
  ...
  - l2
  - lesson
source_spec: "docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md"
---
# T8.1 NR LDPC 译码链路总览
## 本节学习目标
...
| 协议位置 | 本地证据路径 |
| :--- | :--- |
| TS 38.212 §5 General procedures | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 633-635 |
| TS 38.212 §5.1 CRC calculation | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 637-661 |
| TS 38.212 §5.2.2 Low density parity check coding | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 717-805 |
...
| TS 38.212 §5.4.2 Rate matching for LDPC code | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 1175-1323 |
| TS 38.212 §6.2.1-§6.2.6 上行共享信道 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 1359-1411 |
| TS 38.212 §7.2.1-§7.2.6 下行共享信道/寻呼信道（Paging Channel, PCH） | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 3737-3781 |
| TS 38.214 §5.1.7/§6.1.5 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md`，§5.1.7 行 2407-2437；§6.1.5 行 7099-7125 |
...
- 关系语义：本节是 NR 数据译码链路枢纽，连接 demapper LLR、rate recovery、LDPC core、CB/TB CRC 和 HARQ/CBG。

## 协议证据表

| 结论 | 协议依据 | 本地证据 |
|:---|:---|:---|
| NR channel coding 包含 error detection、error correcting、rate matching、interleaving 等环节 | TS 38.212 §5 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 633-635 |
| LDPC CB segmentation 会在超过最大 CB 尺寸时分段，并可为每个 CB 附加 CRC | TS 38.212 §5.2.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 717-805 |
| LDPC 编码使用 BG1/BG2、lifting size、QC-LDPC parity-check matrix | TS 38.212 §5.3.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 945-989 |
| LDPC rate matching 由 bit selection 和 bit interleaving 组成，并使用 circular buffer 与 RV | TS 38.212 §5.4.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 1175-1323 |
| UL-SCH 数据链路包含 TB CRC、BG 选择、分段、编码、rate matching、CB concatenation | TS 38.212 §6.2.1-§6.2.6 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 1359-1411 |
| DL-SCH/PCH 数据链路包含 TB CRC、BG 选择、分段、编码、rate matching、CB concatenation | TS 38.212 §7.2.1-§7.2.6 | `3GPP_Rel19/processed/TS_38.212_38212-j30/TS_38.212_38212-j30_content.md` 行 3737-3781 |
| PDSCH CBG 接收由 TS 38.214 给出，包括 CBG 分组、CBGTI 和 CBGFI | TS 38.214 §5.1.7 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md` 行 2407-2437 |
| PUSCH CBG 传输由 TS 38.214 给出，包括 CBG 分组和下行控制信息 format 0_1 的 CBGTI | TS 38.214 §6.1.5 | `3GPP_Rel19/processed/TS_38.214_38214-j30/TS_38.214_38214-j30_content.md` 行 7099-7125 |
## 执行与证据记录
...
| 审核经理复核 | Critical=0；Important=2 已修复：CB CRC 已改为条件性流程并新增 `cb_crc_present`；TS 38.214 §6.1.5 已补 `TS_36.212_36212-j30_content.md` 行 7099-7125 精确证据。Minor 已处理：补 descriptor 字段解释，并明确教学数值不是规范向量。 |
| 自动审计 | `python3 tools/audit_lesson_terms.py docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md` 输出 `LESSON_TERM_AUDIT_OK`；`python3 tools/audit_markdown_headings.py docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md` 输出 `MARKDOWN_HEADING_AUDIT_OK`；`python3 tools/audit_lesson_depth.py --strict docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md` 输出 `LESSON_DEPTH_AUDIT_OK`；`python3 tools/audit_latex_render.py docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md` 输出 `LATEX_RENDER_AUDIT_OK formulas=40`。 |

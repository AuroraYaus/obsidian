...
如果前置知识不足，先回看 T2.8、T4.5、T6.7、T7.3、T7.4 和 T12.1。本节默认你已经理解“协议位序必须 bit-exact，算法曲线和阈值是工程评估”这个边界。
...
| LTE Turbo encoder | TS 36.212 §5.1.3.2.1、Figure 5.1.3-2 | `3GPP_Rel19/processed/TS_36.212_36212-j30/content.md`；T6.3 重建图 `docs/L2/assets/T6.3_TS36.212_Figure_5.1.3-2_turbo_encoder_rebuild.png` | 已重建图。 |
...
## 图示
![图 1：LTE Turbo float sim flow](assets/T12.2_LTE_Turbo_float_sim_flow.png)

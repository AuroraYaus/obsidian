...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md"
---
...
| T8.3 | `docs/L2/T8.3_NR_LDPC_lifting_QC_matrix.md` | T19.2 把它映射到 RTL 地址和 bank。 |
| T8.7 | `docs/L2/T8.7_layered_LDPC_decoding_schedule.md` | T19.2 扩展为微架构和验证字段。 |
| T18.3 | `docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md` | T19.2 把对象变成 RTL 端口、SRAM、counter 和 trace。 |
| T18.6 | `docs/L3/T18.6_bit_exact_regression_harness.md` | 本节只定义 RTL 侧怎么输出这些 checkpoint。 |
...
## 图示
![图 1：NR LDPC RTL microarchitecture](assets/T19.2_NR_LDPC_RTL_microarchitecture.png)
...
- `docs/L3/assets/T19.2_NR_LDPC_RTL_microarchitecture.png`

已执行表格生成和图形审计：

```bash
python3 tools/figures/render_t14_2_nr_ldpc_rtl_microarchitecture.py
# WROTE docs/L3/assets/T19.2_NR_LDPC_RTL_microarchitecture.png (2500, 2440)
...
```bash
python3 tools/audit_lesson_terms.py docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md
# LESSON_TERM_AUDIT_OK

python3 tools/audit_markdown_headings.py docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md
# MARKDOWN_HEADING_AUDIT_OK

python3 tools/audit_lesson_depth.py --strict docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md
# LESSON_DEPTH_AUDIT_OK

python3 tools/audit_latex_render.py docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md
# LATEX_RENDER_AUDIT_OK formulas=85

python3 tools/audit_reference_rebuilds.py docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md
...
- `docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md`，NR LDPC C/C++ 定点模型计划。
- `docs/L3/T18.6_bit_exact_regression_harness.md`，bit-exact 回归框架和 LDPC checkpoint manifest。

...
## 图示
![图 1：NR LDPC RTL microarchitecture](assets/T14.2_NR_LDPC_RTL_microarchitecture.svg)
...
- `docs/L3/assets/T14.2_NR_LDPC_RTL_microarchitecture.svg`（手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG；原 `tools/figures/render_t14_2_nr_ldpc_rtl_microarchitecture.py` 与 `T14.2_NR_LDPC_RTL_microarchitecture.png` 已删除，图示语义与数据不变）

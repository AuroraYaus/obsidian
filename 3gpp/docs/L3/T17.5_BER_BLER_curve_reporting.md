...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T17.5_BER_BLER_curve_reporting.md"
---
...
python3 -m decoder_golden.reporting.build_report_bundle \
  ...
  --protocol-refs docs/L3/T17.2_LTE_Turbo_float_sim_plan.md docs/L3/T17.3_NR_LDPC_float_sim_plan.md docs/L3/T17.4_NR_Polar_float_sim_plan.md \
  --include-failures 20 \
...
| 写入文件 | `docs/L3/T17.5_BER_BLER_curve_reporting.md` |
| 新增证据资产 | `docs/L3/assets/T12.5_BER_BLER_curve_reporting.svg`（手绘 SVG，替代原 PIL 渲染 PNG 及 `tools/figures/render_t12_5_ber_bler_curve_reporting.py`）。 |
...
| 前置依据 | 已读取 `docs/L1/T4.5_decoder_performance_metrics.md`、`docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`、`docs/L3/T17.3_NR_LDPC_float_sim_plan.md`、`docs/L3/T17.4_NR_Polar_float_sim_plan.md`。 |
...
| 审计结果 | `python3 tools/audit_lesson_terms.py docs/L3/T17.5_BER_BLER_curve_reporting.md`：`LESSON_TERM_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_markdown_headings.py docs/L3/T17.5_BER_BLER_curve_reporting.md`：`MARKDOWN_HEADING_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_lesson_depth.py --strict docs/L3/T17.5_BER_BLER_curve_reporting.md`：`LESSON_DEPTH_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_latex_render.py docs/L3/T17.5_BER_BLER_curve_reporting.md`：`LATEX_RENDER_AUDIT_OK formulas=42`。 |
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L3/T17.5_BER_BLER_curve_reporting.md` 返回 `REFERENCE_REBUILD_AUDIT_CANDIDATES`，退出码为 0；候选来自本节明确声明不复现的协议公式/表格边界、DCI blind detection 边界和 README 公式权威性提示，不构成本节失败。 |
...
- [上游讲义] `docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`，LTE Turbo 浮点仿真计划。
- [上游讲义] `docs/L3/T17.3_NR_LDPC_float_sim_plan.md`，NR LDPC 浮点仿真计划。

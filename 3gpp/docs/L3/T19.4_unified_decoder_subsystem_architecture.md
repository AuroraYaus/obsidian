...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T19.4_unified_decoder_subsystem_architecture.md"
---
...
| T19.1-T19.3 | `docs/L3/T19.1*`、`T19.2*`、`T19.3*` | 本节不重写每个 engine 内部算法。 |
...
| Turbo engine 私有结构来自 T19.1。 | T19.1 本项目讲义。 | `docs/L3/T19.1_LTE_Turbo_RTL_microarchitecture.md` | alpha/beta/extrinsic/SISO 是 engine-local。 |
| LDPC engine 私有结构来自 T19.2。 | T19.2 本项目讲义。 | `docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md` | QC schedule/message RAM/bank conflict 是 engine-local。 |
| Polar engine 私有结构来自 T19.3。 | T19.3 本项目讲义。 | `docs/L3/T19.3_NR_Polar_RTL_microarchitecture.md` | path/PM/sorter/CRC selector 是 engine-local。 |
| Trace/failure bundle 命名来自 T18.6。 | T18.6 本项目讲义。 | `docs/L3/T18.6_bit_exact_regression_harness.md` | 项目验证要求，不是 3GPP 条款。 |
...
| 图形资产 | `docs/L3/assets/T14.4_unified_decoder_subsystem_architecture.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t14_4_unified_decoder_subsystem.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |
| 术语审计 | `python3 tools/audit_lesson_terms.py docs/L3/T19.4_unified_decoder_subsystem_architecture.md` | `LESSON_TERM_AUDIT_OK`。 |
| 标题审计 | `python3 tools/audit_markdown_headings.py docs/L3/T19.4_unified_decoder_subsystem_architecture.md` | `MARKDOWN_HEADING_AUDIT_OK`。 |
| 深度审计 | `python3 tools/audit_lesson_depth.py --strict docs/L3/T19.4_unified_decoder_subsystem_architecture.md` | `LESSON_DEPTH_AUDIT_OK`。 |
| LaTeX 渲染审计 | `python3 tools/audit_latex_render.py docs/L3/T19.4_unified_decoder_subsystem_architecture.md` | `LATEX_RENDER_AUDIT_OK formulas=5`。 |
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L3/T19.4_unified_decoder_subsystem_architecture.md` | `REFERENCE_REBUILD_AUDIT_CANDIDATES`；候选为 TS 36.213/TS 38.331 `待核验` 上下文、实现边界和工程解释，不构成本节阻塞。 |
...
| 微架构前置 | `docs/L3/T19.1_LTE_Turbo_RTL_microarchitecture.md`；`docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md`；`docs/L3/T19.3_NR_Polar_RTL_microarchitecture.md`。 |
| 验证回链 | `docs/L3/T18.6_bit_exact_regression_harness.md`。 |

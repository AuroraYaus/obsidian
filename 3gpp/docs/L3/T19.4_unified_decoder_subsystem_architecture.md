...
## 图示
![图 1：unified decoder subsystem architecture](assets/T19.4_unified_decoder_subsystem_architecture.png)
...
| 图形生成 | `python3 tools/figures/render_t14_4_unified_decoder_subsystem.py` | `WROTE .../docs/L3/assets/T19.4_unified_decoder_subsystem_architecture.png (2600, 2400)`。 |

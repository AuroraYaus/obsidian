...
| 前置依据 | 已读取 `docs/L2/T10.3_NR_Polar_reliability_sequence.md`、`docs/L2/T10.6_CRC_aided_SCL_control_reliability.md`、`docs/L2/T10.7_NR_Polar_rate_recovery.md`、`docs/L3/T17.1_python_golden_model_project_layout.md`。 |

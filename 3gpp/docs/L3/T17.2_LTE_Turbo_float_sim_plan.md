...
| 前置依据 | 已读取 `docs/L2_协议算法/T6.7_Turbo_iteration_extrinsic_stopping.md`、`docs/L2_协议算法/T7.4_LTE_code_block_reassembly_TB_CRC.md`、`docs/L3/T17.1_python_golden_model_project_layout.md`。 |

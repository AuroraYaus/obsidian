...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T17.2_LTE_Turbo_float_sim_plan.md"
---
...
| LTE Turbo encoder | TS 36.212 §5.1.3.2.1、Figure 5.1.3-2 | `3GPP_Rel19/processed/TS_36.212_36212-j30/content.md`；T6.3 重建图 `docs/L2/assets/T6.3_TS36.212_Figure_5.1.3-2_turbo_encoder_rebuild.svg` | 已重建图。 |
...
| 写入文件 | `docs/L3/T17.2_LTE_Turbo_float_sim_plan.md` |
| 新增证据资产 | `docs/L3/assets/T12.2_LTE_Turbo_float_sim_flow.svg`（手绘 SVG，替代原 PIL 渲染 PNG 及 `tools/figures/render_t12_2_lte_turbo_float_sim_flow.py`）。 |
...
| 前置依据 | 已读取 `docs/L2/T6.7_Turbo_iteration_extrinsic_stopping.md`、`docs/L2/T7.4_LTE_code_block_reassembly_TB_CRC.md`、`docs/L3/T17.1_python_golden_model_project_layout.md`。 |
...
| 审计结果 | `python3 tools/audit_lesson_terms.py docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`：`LESSON_TERM_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_markdown_headings.py docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`：`MARKDOWN_HEADING_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_lesson_depth.py --strict docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`：`LESSON_DEPTH_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_latex_render.py docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`：`LATEX_RENDER_AUDIT_OK formulas=91`。 |
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L3/T17.2_LTE_Turbo_float_sim_plan.md` 返回 `REFERENCE_REBUILD_AUDIT_CANDIDATES`，退出码为 0；候选来自 TS 36.213 MCS/TBS 明确 `待核验`、TS 36.212 表/图已由上游讲义重建的回链，以及正文公式引用，不构成本节失败。 |

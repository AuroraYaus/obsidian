...
| 资料 | 本地路径 | 边界 |
| :--- | :--- | :--- |
| TS 36.212 §5.1.1 | `3GPP_Rel19/processed/TS_36.212_36212-j30/content.md:575-599` | CRC 算法由上游 T3.1/T12.2 回链，本节只消费状态。 |
...
## 图示
![图 1：LTE Turbo fixed point model](assets/T13.2_LTE_Turbo_fixed_point_model.png)

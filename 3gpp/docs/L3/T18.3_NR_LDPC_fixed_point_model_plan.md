...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md"
---
...
| T17.3 | `docs/L3/T17.3_NR_LDPC_float_sim_plan.md` | 本节不生成真实 fixed BLER 曲线。 |
...
| 写入文件 | `docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md` |
| 新增证据资产 | `docs/L3/assets/T13.3_NR_LDPC_fixed_point_model.svg`（手绘 SVG，替代原 PIL 渲染 PNG 及 `tools/figures/render_t13_3_nr_ldpc_fixed_point_model.py`）。 |
...
| 上游讲义 | 已读取 `docs/L2/T8.6_LDPC_MS_NMS_OMS.md`、`docs/L2/T8.7_layered_LDPC_decoding_schedule.md`、`docs/L3/T17.3_NR_LDPC_float_sim_plan.md`、`docs/L3/T18.1_fixed_point_decoder_requirements.md`。 |
| 术语审计 | `python3 tools/audit_lesson_terms.py docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md`：`LESSON_TERM_AUDIT_OK`。 |
| 标题审计 | `python3 tools/audit_markdown_headings.py docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md`：`MARKDOWN_HEADING_AUDIT_OK`。 |
| 深度审计 | `python3 tools/audit_lesson_depth.py --strict docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md`：`LESSON_DEPTH_AUDIT_OK`。 |
| LaTeX 审计 | `python3 tools/audit_latex_render.py docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md`：`LATEX_RENDER_AUDIT_OK formulas=55`。 |
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L3/T18.3_NR_LDPC_fixed_point_model_plan.md`：`REFERENCE_REBUILD_AUDIT_CANDIDATES`，候选来自上游已重建 TS 38.212 表格回链、实现策略边界、论文引用和 TS 38.214 MCS/TBS 条件项；本节未直接使用 MCS/TBS 表值。 |

...
| TS 36.212 Rel-19 `36212-j30` §5.1.2、§5.1.3.2、§5.1.4.1 | `3GPP_Rel19/processed/TS_36.212_36212-j30/content.md`，`sections.jsonl` | LTE CB segmentation、Turbo coding、rate matching/RV 是 T12.2 向量字段来源。 | 具体地址、交织和 RV 恢复由 T12.2 使用。 |
| TS 38.212 Rel-19 `38212-j30` §5.1、§5.2.2、§5.3.2、§5.4.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md`，`sections.jsonl` | NR LDPC CRC、segmentation、base graph/lifting、rate matching 是 T12.3 向量字段来源。 | CRC 多项式复现见上游讲义；具体 BG/Zc/k0 查表由 T12.3/T8/T9 回链。 |
...
## 图示
![图 1：golden model project layout](assets/T12.1_golden_model_project_layout.png)

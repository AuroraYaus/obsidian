...
| TS 38.212 Rel-19 `38212-j30` §5.4.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md:1249-1315` | 当前抽取件表格公式不完整，正文只使用已核验语义和上游 T9.3 复现边界。 |
...
| TS 38.214 Rel-19 `38214-j30` §6.1.5 | `3GPP_Rel19/processed/TS_38.214_38214-j30/content.md:7099-7125` | 本节只讲译码器/接收侧状态；不展开 PUSCH 调度器。 |
...
| NR LDPC bit selection 通过 `E_r`、RV 和 `k0` 选择每个 CB 的 circular-buffer 输出；CBGTI 未调度时可令该 CB 本次不发送。 | TS 38.212 Rel-19 `38212-j30` §5.4.2。 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md:1249-1315` | 当前抽取件表格公式不完整；本节不冒充 bit-exact 表格重建。 |
...
## 图示
![图 1：soft buffer HARQ memory architecture](assets/T14.5_soft_buffer_HARQ_memory_architecture.png)

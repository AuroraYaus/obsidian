...
| :--- | :--- | :--- | :--- |
| NR LDPC segmentation | TS 38.212 `38212-j30` §5.2.2 | `3GPP_Rel19/processed/TS_38.212_38212-j30/content.md` | 已由 T12.3/T9.5 回链。 |
...
## 图示
![图 1：NR LDPC fixed point model](assets/T13.3_NR_LDPC_fixed_point_model.png)

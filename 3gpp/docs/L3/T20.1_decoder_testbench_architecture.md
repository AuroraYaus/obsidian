...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T20.1_decoder_testbench_architecture.md"
---
...
| LTE 译码协议与工程章节 | `docs/L2/T7.*.md`, `docs/L3/T19.1_LTE_Turbo_RTL_microarchitecture.md` | 本节不重写 Turbo 算法推导。 |
| NR LDPC 协议与工程章节 | `docs/L2/T8.*.md`, `docs/L2/T9.*.md`, `docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md` | 本节不重写 LDPC 协议表。 |
| NR Polar 协议与工程章节 | `docs/L2/T10.*.md`, `docs/L3/T19.3_NR_Polar_RTL_microarchitecture.md` | 本节不重写 Polar construction。 |
| Bit-exact 回归框架 | `docs/L3/T18.6_bit_exact_regression_harness.md` | 本节把它落到 RTL testbench。 |
| 统一子系统与寄存器配置 | `docs/L3/T19.4_unified_decoder_subsystem_architecture.md`, `docs/L3/T19.6_decoder_register_map_configuration_flow.md` | 真实 RTL 端口名以实现为准。 |
...
| 结论 | 证据 | 本地路径 | 边界 |
|:---|:---|:---|:---|
| LTE Turbo RTL 向量必须回链 LTE CB segmentation、Turbo interleaver、rate matching 和 CRC。 | TS 36.212 Rel-19 `36212-j30`；项目 T7/T19.1。 | `3GPP_Rel19/processed/TS_36.212_36212-j30`、`docs/L2/T7.*.md`、`docs/L3/T19.1_LTE_Turbo_RTL_microarchitecture.md` | 本节不重建协议表；T20.2 后续定义 exact vector suite。 |
| NR LDPC RTL 向量必须回链 BG/$Z_c$、rate recovery、RV/k0、CBG 和 CRC/syndrome。 | TS 38.212 Rel-19 `38212-j30`、TS 38.214 Rel-19 `38214-j30`；项目 T8/T9/T19.2。 | `3GPP_Rel19/processed/TS_38.212_38212-j30`、`TS_38.214_38214-j30`、`docs/L2/T8.*.md`、`docs/L2/T9.*.md`、`docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md` | testbench 只消费已生成向量和 descriptor。 |
| NR Polar RTL 向量必须回链 reliability/frozen mask、rate recovery、CRC/RNTI 和 SCL/CA-SCL 选择语义。 | TS 38.212 Rel-19 `38212-j30`；项目 T10/T19.3。 | `3GPP_Rel19/processed/TS_38.212_38212-j30`、`docs/L2/T10.*.md`、`docs/L3/T19.3_NR_Polar_RTL_microarchitecture.md` | list size、PM 近似、sorter 是实现策略。 |
| vector schema、checkpoint manifest、failure bundle 的字段来自项目 bit-exact 框架。 | T18.6。 | `docs/L3/T18.6_bit_exact_regression_harness.md` | 工程回归框架，不是 3GPP 条文。 |
| register/status/error/IRQ/trace 驱动对象来自统一子系统和寄存器配置流。 | T19.4、T19.6。 | `docs/L3/T19.4_unified_decoder_subsystem_architecture.md`、`docs/L3/T19.6_decoder_register_map_configuration_flow.md` | 真实端口名、总线协议和地址以 RTL 实现为准。 |

## 图示
![图 1：decoder testbench architecture](assets/T20.1_decoder_testbench_architecture.png)
...
| 图形生成 | `python3 tools/figures/render_t15_1_decoder_testbench_architecture.py` | `WROTE .../docs/L3/assets/T20.1_decoder_testbench_architecture.png (2800, 2380)`。 |
...
- [Project, 2026] T19.1 LTE Turbo RTL microarchitecture, `docs/L3/T19.1_LTE_Turbo_RTL_microarchitecture.md`.
- [Project, 2026] T19.2 NR LDPC RTL microarchitecture, `docs/L3/T19.2_NR_LDPC_RTL_microarchitecture.md`.
- [Project, 2026] T19.3 NR Polar RTL microarchitecture, `docs/L3/T19.3_NR_Polar_RTL_microarchitecture.md`.
- [Project, 2026] T19.4 Unified decoder subsystem architecture, `docs/L3/T19.4_unified_decoder_subsystem_architecture.md`.
- [Project, 2026] T19.6 Decoder register map and configuration flow, `docs/L3/T19.6_decoder_register_map_configuration_flow.md`.

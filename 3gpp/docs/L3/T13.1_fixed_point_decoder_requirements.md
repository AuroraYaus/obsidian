...
## 图示
![图 1：fixed point decoder requirements](assets/T13.1_fixed_point_decoder_requirements.png)
...
| 上游讲义 | 已读取 `docs/L1/T2.11_LLR_clipping_scaling_quantization.md`、`docs/L1/T5.1_fixed_point_numbers_for_LLR.md`、`docs/L3/T12.1_python_golden_model_project_layout.md`。 |

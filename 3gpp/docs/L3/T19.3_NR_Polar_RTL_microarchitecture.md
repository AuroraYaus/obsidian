...
## 图示
![图 1：NR Polar RTL microarchitecture](assets/T14.3_NR_Polar_RTL_microarchitecture.svg)
...
| 图形资产 | `docs/L3/assets/T14.3_NR_Polar_RTL_microarchitecture.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t14_3_nr_polar_rtl_microarchitecture.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |

...
| LTE 边界章节 | `docs/L2/T7.6_LTE_Turbo_decoder_edge_cases.md` | T20.2 转换为套件清单，不重写 T7.6 全部解释。 |
| NR LDPC 边界章节 | `docs/L2/T9.6_NR_LDPC_decoder_edge_cases.md` | T20.2 只汇总为向量矩阵。 |
| NR Polar 边界章节 | `docs/L2/T10.8_NR_Polar_decoder_edge_cases.md` | T20.2 不重新推导 SCL。 |
...
## 图示
![图 1：protocol vector corner case suite](assets/T20.2_protocol_vector_corner_case_suite.png)
...
| 依赖读取 | `docs/L2/T7.6_LTE_Turbo_decoder_edge_cases.md`、`docs/L2/T9.6_NR_LDPC_decoder_edge_cases.md`、`docs/L2/T10.8_NR_Polar_decoder_edge_cases.md`、`docs/L3/T18.6_bit_exact_regression_harness.md`、`docs/L3/T20.1_decoder_testbench_architecture.md`。 | 已抽取三类 directed cases、最小 dump 字段、vector schema 和 testbench 消费方式。 |
| 图形生成 | `python3 tools/figures/render_t15_2_protocol_vector_corner_case_suite.py` | 写出 `docs/L3/assets/T20.2_protocol_vector_corner_case_suite.png (3000, 3060)`。 |
...
| 资产人工复核 | `view_image docs/L3/assets/T20.2_protocol_vector_corner_case_suite.png` | 首轮发现表格右边界贴近画布和底部说明框接触表格；已缩表宽、加高画布并下移说明框，复检通过。 |

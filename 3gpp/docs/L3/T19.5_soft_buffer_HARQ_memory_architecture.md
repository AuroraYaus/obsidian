...
| T7.3 | `docs/L2_协议算法/T7.3_LTE_HARQ_soft_buffer_RV.md` | T19.5 升级为存储架构，不重复所有 rate matching 推导。 |
| T9.3 | `docs/L2_协议算法/T9.3_NR_LDPC_HARQ_soft_buffer_RV_k0.md` | T19.5 升级为 bank/transaction/lifecycle 架构。 |
...
## 图示
![图 1：soft buffer HARQ memory architecture](assets/T14.5_soft_buffer_HARQ_memory_architecture.svg)
...
| 图形资产 | `docs/L3/assets/T14.5_soft_buffer_HARQ_memory_architecture.svg` | 手绘 SVG，2026-08-04 替代原 PIL 渲染 PNG（原 `render_t14_5_soft_buffer_harq_memory.py` 与 PNG 已删除，图示语义不变）；SVG 几何审计六项检查全部通过，cairosvg 渲染验证无报错。 |
...
- [Project, 2026] T7.3 LTE HARQ soft buffer and RV lesson, `docs/L2_协议算法/T7.3_LTE_HARQ_soft_buffer_RV.md`.
- [Project, 2026] T9.3 NR LDPC HARQ soft buffer, RV k0 and CBG lesson, `docs/L2_协议算法/T9.3_NR_LDPC_HARQ_soft_buffer_RV_k0.md`.

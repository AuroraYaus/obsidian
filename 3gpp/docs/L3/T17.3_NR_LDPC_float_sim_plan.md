...
| 前置依据 | 已读取 `docs/L2_协议算法/T8.8_NR_LDPC_decoder_numeric_walkthrough.md`、`docs/L2_协议算法/T9.5_NR_LDPC_reassembly_TB_CRC.md`、`docs/L3/T17.1_python_golden_model_project_layout.md`。 |

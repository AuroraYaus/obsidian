...
tags:
  ...
  - l3
  - lesson
source_spec: "docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md"
---
...
| T17.2 | `docs/L3/T17.2_LTE_Turbo_float_sim_plan.md` | 本节不生成真实 BLER 曲线。 |
...
## 图示
![图 1：LTE Turbo fixed point model](assets/T13.2_LTE_Turbo_fixed_point_model.svg)
...
| 写入文件 | `docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md` |
| 新增证据资产 | `docs/L3/assets/T13.2_LTE_Turbo_fixed_point_model.svg`（手绘 SVG，替代原 PIL 渲染 PNG 及 `tools/figures/render_t13_2_lte_turbo_fixed_point_model.py`）。 |
...
| 上游讲义 | 已读取 `docs/L2/T6.6_Log_MAP_Max_Log_MAP_Turbo.md`、`docs/L2/T7.3_LTE_HARQ_soft_buffer_RV.md`、`docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`、`docs/L3/T18.1_fixed_point_decoder_requirements.md`。 |
| 审计结果 | `python3 tools/audit_lesson_terms.py docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md`：`LESSON_TERM_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_markdown_headings.py docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md`：`MARKDOWN_HEADING_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_lesson_depth.py --strict docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md`：`LESSON_DEPTH_AUDIT_OK`。 |
| 审计结果 | `python3 tools/audit_latex_render.py docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md`：`LATEX_RENDER_AUDIT_OK formulas=57`。 |
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L3/T18.2_LTE_Turbo_fixed_point_model_plan.md`：`REFERENCE_REBUILD_AUDIT_CANDIDATES`，候选为 TS 36.212 表/关系式回链、T6.4/T17.2 已重建资产、实现策略边界、论文引用和 TS 36.213 MCS/TBS 条件项；本节未直接使用 MCS/TBS 表值。 |

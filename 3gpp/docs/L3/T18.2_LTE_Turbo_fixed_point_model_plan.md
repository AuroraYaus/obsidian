...
| 上游讲义 | 已读取 `docs/L2_协议算法/T6.6_Log_MAP_Max_Log_MAP_Turbo.md`、`docs/L2_协议算法/T7.3_LTE_HARQ_soft_buffer_RV.md`、`docs/L3/T17.2_LTE_Turbo_float_sim_plan.md`、`docs/L3/T18.1_fixed_point_decoder_requirements.md`。 |

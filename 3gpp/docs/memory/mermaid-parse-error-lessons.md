---
name: mermaid-parse-error-lessons
description: Mermaid parse error 漏检教训——T2.0 括号问题被漏掉 4 层原因（范围盲区/工具形同虚设/修复不彻底/扫描规则针对性）；固化引号节点规则与验证手段
metadata: 
  node_type: memory
  type: feedback
  originSessionId: 30cc3013-8452-437a-8c46-a0e217366592
  modified: 2026-08-04T14:49:03.834Z
---
...
4. **扫描规则是"针对性的"**：全库扫描只查方括号嵌套模式（`\[[^\]]*\[`），没查圆括号——扫描规则按"已发现问题"设计，重蹈 [[svg-audit-blind-spots]] 的"针对性代替全量"教训

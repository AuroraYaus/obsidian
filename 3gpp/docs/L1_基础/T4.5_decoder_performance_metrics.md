...
| 风格参考 | 已读取 `docs/L1_基础/T2.7_AWGN_noise_scaling.md`、`docs/L1_基础/T4.3_HARQ_soft_combining_basics.md`、`docs/L1_基础/T5.3_throughput_latency_parallelism.md`、`docs/L1_基础/T5.5_decoder_hardware_verification_mindset.md`。 |
...
| 引用重建审计 | `python3 tools/audit_reference_rebuilds.py docs/L1_基础/T4.5_decoder_performance_metrics.md` 返回 `REFERENCE_REBUILD_AUDIT_CANDIDATES`，退出码为 0；候选为本节自写工程统计公式、T2.7 噪声缩放引用说明和执行记录中的“公式”字样，未发现本节新增外部协议表/图/公式缺失复现项。 |

...
[[T2.1_OFDM_subcarrier_spacing_basics|T2.1]]–[[T2.3_NR_frequency_resource_grid|T2.3]] 构建了 LTE 和 NR 的完整时频资源框架。网格建好之后，调度层需要回答一个核心问题：每个 RE 里装多少比特？
...
| 问题 | 需要达到的程度 |
|:---|:---|
| RE 和 PRB 是什么？ | 能说出 RE = 1 子载波 × 1 符号，PRB = 12 子载波（[[T2.3_NR_frequency_resource_grid|T2.3]]）。 |

...
| 新增证据资产 | `docs/L1_基础/assets/T3.2_circular_buffer_decision3.svg`、`docs/L1_基础/assets/T3.2_circular_buffer_interleaving.svg`（手绘 SVG，替代原脚本渲染 PNG 及 `tools/figures/render_circular_buffer_decision3.py`、`tools/figures/render_t3.2_circular_buffer_interleaving.py`；脚本与 PNG 已删除，git 可恢复）。 |

...
| TS 38.212 Polar reliability sequence 与 rate recovery | 已覆盖 T10，含可靠性序列、SC/SCL、CA-SCL、rate recovery 和边界案例。 | `docs/L2_协议算法/T10.*.md`；`docs/L2_协议算法/assets/T10.3_TS38.212_Table_5.3.1.2-1_Polar_sequence.png`。 |

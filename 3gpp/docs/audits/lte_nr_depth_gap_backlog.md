...
范围：当前项目 `docs/L1`、`docs/L2`、`docs/L3` 共 94 篇讲义，以及必要的 `tools/figures`、`docs/audits`、路线图和全局规则。
...
| 当前章节 | 写当前项目受影响文件路径，例如 `docs/L2/T8.5_LDPC_sum_product_BP.md`。 |
...
| B3-01 | `T2.1_AWGN_noise_scaling.md` | 深度、工程 | `ldpc/docs/L1_理论基础/T1.6_AWGN信道模型与噪声特性.md` | 补实基带和复基带噪声方差差异；补 `N0/2`、Eb/N0、Es/N0、码率、调制阶数换算；列四类 LLR scaling bug。 | 增加噪声缩放错误诊断表；可选 Python 曲线图。 |
| B3-02 | `T2.3_QAM_Max_Log_MAP_demapping.md` | 深度、协议 | `ldpc/docs/L1_理论基础/T1.5_数字调制BPSK_QPSK_QAM.md` | 补 QAM 星座能量归一化、Gray 映射、1024QAM 复杂度、bit-channel 可靠性；核验 TS 36.211/38.211 调制入口。 | 若引用 1024QAM，必须记录 Rel-19 本地路径；建议补星座和 bit-channel 图。 |
...
- `/home/yys/ClaudeCode/LDPC_Basics/LDPC_TS_36.213_36213-j30_s00-s05_index.md`
...
- `docs/L2/T8.4_LDPC_Tanner_graph_message_passing.md`
...
- `docs/L2/T6.5_BCJR_MAP_decoding_intuition.md`
...
- `docs/L1/T2.1_AWGN_noise_scaling.md`
- `docs/L1/T2.2_BPSK_QPSK_soft_demapping.md`
- `docs/L1/T2.3_QAM_Max_Log_MAP_demapping.md`
...
- `docs/L2/T6.1_LTE_Turbo_decoder_chain_overview.md`
- `docs/L2/T11.1_Turbo_LDPC_Polar_algorithm_comparison.md`
...
- `docs/L2/T6.5_BCJR_MAP_decoding_intuition.md`
- `docs/L2/T6.6_Log_MAP_Max_Log_MAP_Turbo.md`
- `docs/L2/T6.7_Turbo_iteration_extrinsic_stopping.md`
...
- `docs/L2/T7.1_LTE_Turbo_de_rate_matching_overview.md`
- `docs/L2/T7.2_LTE_subblock_deinterleaver_circular_buffer.md`
- `docs/L2/T7.3_LTE_HARQ_soft_buffer_RV.md`
- `docs/L2/T7.6_LTE_Turbo_decoder_edge_cases.md`
- `docs/L2/T11.2_LTE_NR_rate_matching_comparison.md`
...
- `docs/L2/T8.1_NR_LDPC_decoder_chain_overview.md`
- `docs/L2/T8.2_NR_LDPC_base_graph_selection.md`
...
- `docs/L2/T8.4_LDPC_Tanner_graph_message_passing.md`
- `docs/L2/T8.5_LDPC_sum_product_BP.md`
- `docs/L2/T8.6_LDPC_MS_NMS_OMS.md`
...
- `docs/L2/T9.1_NR_LDPC_rate_recovery_overview.md`
- `docs/L2/T9.2_NR_LDPC_circular_buffer_states.md`
...
- `docs/L2/T10.1_NR_Polar_decoder_chain_overview.md`
- `docs/L2/T10.2_channel_polarization_frozen_bits.md`
- `docs/L2/T10.3_NR_Polar_reliability_sequence.md`
...
- `docs/L2/T10.7_NR_Polar_rate_recovery.md`
- `docs/L2/T10.8_NR_Polar_decoder_edge_cases.md`
- `docs/L2/T11.2_LTE_NR_rate_matching_comparison.md`
...
```bash
python3 tools/audit_lesson_terms.py docs/L1/T*.md docs/L2/T*.md docs/L3/T*.md
python3 tools/audit_markdown_headings.py docs/L1/T*.md docs/L2/T*.md docs/L3/T*.md
python3 tools/audit_lesson_depth.py --strict docs/L1/T*.md docs/L2/T*.md docs/L3/T*.md
python3 tools/audit_latex_render.py docs/L1/T*.md docs/L2/T*.md docs/L3/T*.md

...
```python
    ...
    "CA-SCL": "CRC 辅助串行消除列表（CRC-Aided Successive Cancellation List, CA-SCL）",
    "SCL": "串行消除列表（Successive Cancellation List, SCL）",
    ...
    "EVM": "误差向量幅度（Error Vector Magnitude, EVM）",

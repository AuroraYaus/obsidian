...
type: spec
aliases:
  - TS 36.213 36213-j30 s14-xx
tags:
  - 3gpp
  - rel19
  - processed
  - protocol-text
source_spec: "3GPP_Rel19/processed/TS_36.213_36213-j30_s14-xx/TS_36.213_36213-j30_s14-xx_content.md"
---
...
the UE shall set the TS_36.211_36211-j30_s06-s08_contents of the SCI format 0 as follows:
...
-The UE shall set the TS_36.211_36211-j30_s06-s08_contents of the SCI format 1 as follows:
...
Nr-bit =15, and the TS_36.211_36211-j30_s06-s08_content of these 15 bits starting with the MSB and ending with the LSB are as follows:
...
If the UE is configured with higher layer parameter edt-Parameters and the most recent NPUSCH transmission including a transport block with EDT, the UE is not expected to receive a DCI indicating a NPUSCH retransmission as part of the TS_36.211_36211-j30_s06-s08_contention based random access procedure with 3 ≤ IMCS ≤ 14.

If the UE is configured with higher layer parameter edt-Parameters, and for a NPUSCH retransmission of the same transport block including EDT as part of the TS_36.211_36211-j30_s06-s08_contention based random access procedure with  in the DCI,
...
elseif the UE is configured with higher layer parameter edt-Parameters, and if the DCI indicates a retransmission as part of the TS_36.211_36211-j30_s06-s08_contention based random access procedure with  and the most recent NPUSCH transmission including a transport block with EDT,
...
For a NB-IoT UE in a NTN serving cell, the UE is not required to monitor NPDCCH within the GNSS measurement gap duration, until it reacquires GNSS position and a TS_36.211_36211-j30_s06-s08_contention based Random Access is performed as specified in TS 36.321 [8].
...
For a BL/CE UE in a NTN FDD serving cell, the UE is not required to monitor MPDCCH within the GNSS measurement gap duration, until it reacquires GNSS position and a TS_36.211_36211-j30_s06-s08_contention based Random Access is performed as specified in TS 36.321 [8].

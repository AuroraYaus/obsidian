...
16.15.4.2.4 RLC Retransmissions 246
...
16.16 ECN marking for L4S and congestion information exposure 247
...
21.2.4 QoE Measurement Handling in RRC_IDLE and RRC_INACTIVE States 281
...
![](media_svg/image37.svg) [公式≈: ^{U}^{E}p_{p}_{b}_{b}e_{e}_{r}_{r}_{u}^{p}r_{r}_{o}_{o}_{n}^{e}i_{i}_{a}_{a}o_{o}_{i}^{r}_{d}_{d}_{c}^{i}d_{d}^{o}_{a}_{c}_{c}i_{i}_{s}^{d}c_{c}_{a}_{a}_{u}_{u}^{M}_{M}_{M}^{M}_{t}a_{a}_{s}_{s}^{i}_{n}_{n}^{c}_{t}_{t}l_{l}_{o}_{O}_{O}_{O}_{O}^{i}_{i}_{i}l_{l}^{i}_{i}_{i}^{a}^{n}_{n}_{n}_{o}_{o}_{n}y_{y}^{n}_{c}_{c}^{l}_{t}_{t}_{t}_{t}^{i}_{i}_{i}_{n}_{n}_{-}_{a}_{a}^{l}^{i}_{h}_{h}_{h}_{h}^{m}_{m}_{m}b_{b}^{y}_{d}^{m}_{s}_{s}_{-}_{-}_{e}_{e}_{e}_{e}r_{r}_{d}_{d}_{e}_{t}_{t}^{u}_{u}_{u}^{u}_{r}_{r}_{r}_{r}^{b}o_{o}_{m}_{e}_{e}_{o}_{o}^{m}_{m}_{m}^{m}^{r}a_{a}_{S}_{S}_{S}_{S}_{m}_{m}_{n}_{n}^{o}_{a}d_{d}_{I}_{I}_{I}_{I}^{a}^{S}_{S}_{S}_{n}^{S}_{a}_{a}c_{c}_{D}_{D}_{(}_{(}_{(}_{(}^{d}^{I}_{I}_{I}_{n}_{n}_{d}a_{a}^{I}_{S}_{S}_{S}_{S}_{L}_{L}^{c}s_{s}_{d}_{d}^{(}_{(}_{(}^{(}_{I}_{I}_{I}_{I}_{o}^{a}t_{t}^{S}_{S}_{S}^{M}_{-}_{B}_{B}_{B}_{-}_{B}^{s}_{o}_{o}_{n}_{S}_{S}^{I}_{I}_{I}o_{o}_{n}_{n}_{n}_{n}^{t}^{B}_{B}_{B}_{n}_{n}^{I}_{C}_{C}n_{n}_{D}_{)}_{)}_{)}_{)}^{B}^{o}^{1}_{1}_{1}_{D}_{D}_{H}_{H}D_{D}^{n}_{L}^{)}^{)}_{)}_{)}_{L}_{L}_{-}L_{L}^{B}_{S}_{-}_{-}-_{-}^{C}_{S}_{S}_{C}S_{S}_{C}_{C}^{H}C_{C}_{H}_{H}_{H}H_{H}^{g}^{N}^{B}]
...
![](media_svg/image38.svg) [公式≈: ^{U}^{U}^{E}^{E}^{i}^{i}^{C}^{n}^{n}^{U}^{M}^{R}^{R}^{E}^{-}^{R}^{R}^{C}^{i}^{C}^{C}^{n}^{C}^{C}^{O}^{M}^{M}^{R}^{_}^{_}^{U}^{N}^{-}^{-}^{C}^{C}^{R}^{I}^{I}^{N}^{E}^{D}^{D}^{O}^{O}^{C}^{E}^{L}^{L}^{_}^{N}^{N}8^{E}^{E}^{C}^{I}^{N}^{N}a^{D}^{T}.^{E}^{E}^{L}^{E}^{4}^{7}R^{7}^{5}^{E}^{C}^{C}^{D}^{a}^{a}^{.}^{.}R^{2}^{8}^{T}^{T}^{.}^{.}^{S}^{U}^{a}^{.}^{1}C^{E}^{E}^{D}^{S}^{e}^{.}^{R}^{.}^{L}^{D}^{D}R^{e}^{c}^{L}^{R}^{R}^{R}^{c}^{I}^{u}e^{I}^{n}^{R}^{2}^{u}^{R}^{C}^{r}c^{n}^{f}^{.}^{i}^{r}^{C}o^{C}^{f}^{o}^{R}^{t}^{i}^{o}^{R}^{y}n^{t}^{r}^{S}^{S}^{e}^{r}^{y}^{M}^{m}f^{R}^{e}^{c}^{e}^{m}i^{M}g^{t}^{C}^{t}^{o}^{a}^{o}^{u}^{u}^{a}u^{o}^{n}^{t}^{d}^{S}^{p}^{p}^{t}^{i}r^{d}^{f}^{i}^{e}^{o}^{e}^{C}^{R}^{i}a^{o}^{e}^{C}^{g}^{t}^{n}t^{u}^{o}^{n}^{e}^{C}^{u}i^{T}^{o}^{q}o^{p}^{m}^{T}^{r}^{o}^{r}^{m}^{u}n^{r}^{a}^{a}^{p}^{m}^{a}^{e}C^{m}^{t}^{n}^{l}^{i}^{s}^{n}^{p}^{e}^{o}o^{s}^{a}^{t}^{t}^{s}^{l}^{f}^{n}m^{e}^{e}^{n}^{f}^{e}^{e}^{t}^{d}^{r}p^{e}^{r}lete^{g}^{N}^{B}_{9}^{6}_{.}^{.}_{I}^{I}_{N}^{N}^{4}_{I}^{.}^{I}^{5}_{T}^{T}^{D}^{a}_{I}^{I}_{A}^{.}^{3}^{O}^{A}^{U}_{L}^{.}^{L}^{W}^{I}^{P}_{C}^{N}^{C}^{N}^{L}_{O}^{I}^{O}^{L}^{I}^{T}^{N}_{N}^{I}^{I}^{N}^{N}^{A}^{K}_{T}^{T}^{L}^{K}_{E}^{E}^{N}_{X}^{U}^{X}^{N}^{A}_{T}^{T}^{E}^{A}^{S}_{S}^{S}^{S}^{M}^{T}_{E}^{E}^{T}^{R}_{T}^{E}^{T}^{R}^{A}_{U}^{S}^{U}^{A}^{N}^{S}_{P}^{P}^{N}^{A}^{S}_{R}^{P}^{S}^{G}^{R}^{P}_{E}^{O}^{E}^{E}^{O}_{S}^{R}^{Q}_{P}^{R}^{T}^{U}_{O}^{T}^{E}_{N}^{S}_{S}^{T}_{E}^{A}^{M}^{F}]
...
![](media_svg/image39.svg) [公式≈: ^{U}^{E}^{i}^{C}^{n}^{M}^{R}^{U}^{-}^{R}^{I}^{E}^{D}^{C}^{L}^{_}_{3}^{E}^{I}_{.}^{D}^{1}_{R}^{L}^{.}_{R}^{E}^{R}_{C}^{R}_{R}^{C}_{e}^{S}_{j}_{e}^{e}_{c}^{t}2^{u}_{t}.^{p}_{(}P^{R}_{w}r^{e}_{a}o^{q}_{i}c_{t}^{u}e_{(}_{t}^{e}d_{e}_{i}^{s}_{m}u_{.}^{t}_{g}r_{e}_{.}e_{)}_{c}c^{g}_{o}a^{N}_{n}n_{g}^{B}n_{e}o_{s}t_{t}_{i}b_{o}e_{n}_{)}handled]
...
![](media_svg/image40.svg) [公式≈: _{U}_{E}^{U}^{E}_{i}^{C}_{C}_{n}^{M}_{M}^{i}_{R}^{n}^{-}_{-}_{R}^{R}^{C}_{C}_{C}^{R}^{O}_{O}_{_}^{C}^{U}^{N}_{N}_{C}^{_}^{N}_{N}^{E}_{O}^{I}^{N}^{E}_{E}_{N}_{5}^{C}_{C}^{A}^{1}_{N}_{.}^{C}^{T}_{T}^{.}_{R}_{E}^{E}_{E}^{T}^{R}_{R}_{C}^{D}_{D}^{I}_{4}^{R}^{V}_{C}_{T}_{.}^{C}^{E}_{E}_{R}_{R}^{R}_{D}_{e}_{R}^{e}_{s}_{C}^{s}_{u}^{u}_{R}_{m}^{m}_{e}_{e}_{s}^{e}_{C}_{u}^{R}_{o}_{m}^{e}_{m}^{q}_{e}^{u}_{p}^{e}_{l}_{e}^{s}_{t}^{t}_{e}^{g}^{N}^{B}3^{2}.^{.}R^{R}E_{6}^{E}_{.}T^{T}_{X}_{9}R_{8}^{R}_{n}_{.}_{.}I^{I}E_{-}_{U}_{P}^{E}_{U}V_{A}_{E}^{V}E_{T}_{A}^{E}_{7}_{C}_{H}_{D}U_{.}_{O}^{U}_{P}_{D}E_{S}_{N}^{E}_{A}_{W}_{R}C_{T}_{T}^{C}_{E}_{I}_{E}O_{H}_{T}^{O}_{S}_{X}_{C}N_{S}^{N}_{S}_{T}_{H}T_{W}_{I}^{T}_{N}_{R}E^{E}_{R}_{I}_{D}_{E}X_{T}^{X}_{E}_{L}T_{C}_{I}^{T}_{Q}_{C}_{E}_{H}R^{R}_{A}_{U}_{A}E^{E}_{T}_{R}_{S}_{E}S_{I}_{E}^{Q}_{E}_{S}P_{O}^{L}_{Q}_{T}^{U}O_{N}^{a}_{U}^{E}_{R}N^{s}^{S}_{E}_{E}^{t}S^{T}_{S}_{S}^{S}E_{P}_{T}^{e}_{O}^{r}^{v}_{N}^{i}^{n}_{S}^{g}_{E}^{g}^{N}^{B}^{A}^{M}^{F}]
...
![](media_svg/image41.svg) [公式≈: ^{U}^{E}^{C}^{M}^{i}^{n}^{-}^{R}^{C}^{R}^{O}^{C}^{U}^{N}^{_}^{N}^{E}^{I}^{N}^{E}^{1}^{C}^{A}^{.}^{C}^{T}^{R}^{E}^{T}^{R}^{D}^{I}_{5}^{V}^{C}_{.}^{E}^{R}_{R}^{e}_{R}^{s}_{C}^{u}^{m}_{S}_{e}^{e}_{t}^{R}_{u}^{e}_{p}^{q}^{u}^{e}^{s}^{t}^{g}^{N}^{B}^{2}_{4}^{.}_{.}_{6}^{R}_{R}_{.}^{E}_{E}_{S}^{T}_{T}_{e}^{R}_{R}_{t}_{u}^{I}_{I}_{p}^{E}_{E}^{V}_{N}_{V}^{E}_{e}_{E}_{w}^{U}_{U}_{R}^{E}_{E}_{R}^{C}_{C}_{C}^{O}_{O}_{C}^{N}_{N}_{o}^{T}_{T}_{n}3^{E}_{n}_{E}._{e}^{X}F_{X}_{c}^{T}a_{T}_{t}i_{i}_{o}l^{R}u_{F}_{n}r^{E}_{A}e^{Q}_{I}t^{L}_{L}o^{U}^{a}_{U}r^{s}^{E}e_{R}^{t}^{S}tr_{E}^{S}^{T}ie^{e}v^{r}e^{v}o^{i}^{n}r^{g}ve^{g}ri^{N}fy^{B}UEcontext^{A}^{M}^{F}]
...
![](media_svg/image42.svg) [公式≈: ^{U}^{E}^{C}^{M}^{i}^{n}^{-}^{R}^{C}^{R}^{O}^{C}^{U}^{N}^{_}^{N}^{E}^{I}^{N}^{E}_{3}^{C}^{A}^{1}_{.}^{C}^{T}^{.}_{R}^{E}^{T}^{R}_{R}^{D}^{I}^{R}^{V}_{C}^{C}^{E}_{R}^{R}_{e}^{e}_{j}_{e}^{s}_{c}^{u}2_{t}^{m}._{(}P^{e}_{w}^{R}r_{a}o^{e}_{i}c_{t}^{q}e_{(}_{t}^{u}d_{e}_{i}^{e}_{m}u_{.}_{g}^{s}r_{e}^{t}_{.}e_{)}_{c}c^{g}_{o}a^{N}_{n}n_{g}^{B}n_{e}o_{s}t_{t}_{i}b_{o}e_{n}_{)}handled]
...
![](media_svg/image43.svg) [公式≈: ^{U}^{E}^{C}^{M}^{i}^{n}^{-}^{R}^{C}^{R}^{O}^{C}^{U}^{N}^{_}^{N}^{E}^{I}^{N}^{E}^{C}^{A}^{C}^{T}^{E}^{T}^{D}^{I}^{V}^{E}^{1}^{L}^{.}^{R}^{a}^{s}^{A}^{3}4^{t}^{N}^{.}.^{S}^{P}R^{P}^{e}^{a}e^{a}^{r}^{g}s^{g}^{v}^{i}u^{n}^{i}^{i}^{n}^{n}m^{g}^{g}^{g}^{2}i^{U}n^{T}^{.}^{g}^{E}g^{r}^{R}^{i}^{N}^{g}f^{A}r^{g}^{B}o^{N}^{e}m^{r}^{P}R^{a}R^{g}C^{i}^{n}_^{g}IN^{g}A^{N}C^{B}TIVE^{A}^{M}^{F}]
...
![](media_svg/image44.svg) [公式≈: ^{U}^{E}^{C}^{M}^{i}^{n}^{-}^{R}^{C}^{R}^{O}^{C}^{U}^{N}^{_}^{N}^{E}^{I}^{N}^{E}^{1}^{C}^{A}^{.}^{C}^{T}_{S}^{R}^{E}_{u}^{T}_{8}^{R}_{s}^{D}^{I}^{R}^{V}_{.}_{p}^{C}_{R}^{N}^{E}_{e}^{R}_{n}_{R}^{A}^{e}_{d}_{C}^{s}^{U}^{u}_{I}_{R}_{n}^{m}^{p}_{e}_{d}_{4}_{l}^{d}^{e}_{i}_{e}_{.}_{c}^{R}^{a}_{a}_{S}_{a}^{t}^{e}_{s}^{e}_{t}_{e}^{q}_{e}_{i}_{o}_{n}^{u}_{n}_{d}^{e}^{s}_{U}^{t}^{g}_{E}^{N}_{t}_{o}^{B}_{I}_{N}3^{2}._{A}^{.}R_{C}^{R}E_{5}_{T}^{E}_{.}T_{I}^{T}_{V}_{X}_{9}R_{7}^{R}_{E}_{n}_{.}_{.}I^{I}E_{-}_{U}_{P}^{E}_{U}V_{A}_{E}^{V}E_{T}_{A}^{E}_{6}_{C}_{H}_{D}U_{.}_{O}^{U}_{P}_{D}E_{S}_{N}^{E}_{A}_{W}_{R}C_{T}_{T}^{C}_{E}_{I}_{E}O_{H}_{T}^{O}_{S}_{X}_{C}N_{S}^{N}_{S}_{T}_{H}T_{W}_{I}^{T}_{N}_{R}E^{E}_{R}_{I}_{D}_{E}X_{T}^{X}_{E}_{L}T_{C}_{I}^{T}_{Q}_{C}_{E}_{H}R^{R}_{A}_{U}_{A}E^{E}_{T}_{R}_{S}_{E}S_{I}_{E}^{Q}_{E}_{S}P_{O}^{L}_{Q}_{T}^{U}O_{N}^{a}_{U}^{E}_{R}N^{s}^{S}_{E}_{E}^{t}S^{T}_{S}_{S}^{S}E_{P}_{T}^{e}_{O}^{r}^{v}_{N}^{i}^{n}_{S}^{g}_{E}^{g}^{N}^{B}^{A}^{M}^{F}]
...
![](media_svg/image45.svg) [公式≈: ^{U}^{E}^{C}^{M}^{i}^{n}^{-}^{R}^{C}^{R}^{O}^{C}^{U}^{N}^{_}^{N}^{E}^{I}^{N}^{E}^{1}^{C}^{A}^{.}^{C}^{T}_{S}^{R}^{E}_{u}^{T}_{4}^{R}_{s}^{D}^{I}^{R}^{V}_{.}_{p}^{C}_{R}^{N}^{E}_{e}^{R}_{n}_{R}^{A}^{e}_{d}_{C}^{s}^{U}^{u}_{I}_{R}_{n}^{m}^{p}_{e}_{d}_{l}^{d}^{e}_{i}_{e}_{c}^{R}^{a}_{a}_{a}^{t}^{e}_{s}^{e}_{t}^{q}_{e}_{i}_{o}^{u}_{n}^{e}^{s}^{t}^{g}^{N}^{B}2_{3}._{.}R_{R}E_{E}T_{T}R_{R}I_{I}E_{E}V_{V}E_{E}_{R}U_{U}_{N}E_{E}_{A}C_{C}_{U}O_{O}_{p}N_{N}_{d}T_{T}_{a}E_{t}_{E}_{e}X_{X}T_{T}R_{F}E_{A}Q_{I}^{L}_{L}U^{a}_{U}^{s}E_{R}^{t}S_{E}^{S}T^{e}^{r}^{v}^{i}^{n}^{g}^{g}^{N}^{B}]
...
![](media_svg/image46.svg) [公式≈: ^{U}^{E}^{C}_{U}^{M}^{i}^{n}_{E}^{-}^{R}^{C}_{i}_{C}_{n}^{R}^{O}_{M}_{R}^{C}^{U}^{N}_{-}_{R}_{I}^{_}^{N}^{E}_{D}_{C}^{I}^{N}^{E}_{L}_{_}^{1}^{C}_{E}^{A}_{I}^{.}_{D}^{C}^{T}^{R}_{L}^{E}^{T}_{5}^{R}_{E}^{D}^{I}^{R}^{V}_{.}^{C}_{R}^{E}^{N}^{R}_{R}^{A}^{e}_{C}^{s}^{u}^{u}_{R}^{m}^{p}_{e}^{d}_{l}^{e}_{e}^{a}^{R}_{a}^{t}^{e}^{e}_{s}^{q}_{e}^{u}^{e}^{s}^{t}^{g}^{N}^{B}2_{3}._{.}R_{R}E_{E}T_{T}R_{R}I_{I}E_{E}V_{V}E_{E}_{R}U_{U}_{R}E_{E}_{C}C_{C}_{R}O_{O}_{e}N_{l}_{N}_{e}T_{T}_{a}E_{s}_{E}_{e}X_{X}T_{T}R_{F}E_{A}_{4}Q_{I}^{L}_{.}_{L}U_{R}^{a}_{U}^{s}E_{e}_{R}^{t}_{l}S_{e}_{E}^{S}T_{a}^{e}_{s}_{e}^{r}^{v}_{U}^{i}^{n}_{E}^{g}_{c}_{o}^{g}_{n}^{N}_{t}_{e}^{B}_{x}_{t}]
...
![](media_svg/image47.svg) [公式≈: ^{U}^{E}^{C}^{M}^{i}^{n}^{-}^{R}^{C}^{R}^{O}^{C}^{U}^{N}^{_}^{N}^{E}^{I}^{N}^{E}^{1}^{C}^{A}^{.}^{C}^{T}_{S}^{R}^{E}_{u}^{T}_{8}^{R}_{s}^{D}^{I}^{V}_{.}_{p}^{C}_{R}^{E}_{e}^{R}_{n}_{R}^{e}_{d}_{C}^{s}^{u}_{I}_{R}_{n}^{m}_{e}_{d}_{4}_{l}^{e}_{i}_{e}_{.}_{c}^{R}_{a}_{S}_{a}^{e}_{s}_{t}_{e}^{q}_{e}_{i}_{o}_{n}^{u}_{n}_{d}^{e}^{s}_{U}^{t}^{g}_{E}^{N}_{t}_{o}^{B}_{I}_{N}3^{2}._{A}^{.}R_{C}^{R}E_{5}_{T}^{E}_{.}T_{I}^{T}_{V}_{X}_{9}R_{7}^{R}_{E}_{n}_{.}_{.}I^{I}E_{-}_{U}_{P}^{E}_{U}V_{A}_{E}^{V}E_{T}_{A}^{E}_{6}_{C}_{H}_{D}U_{.}_{O}^{U}_{P}_{D}E_{S}_{N}^{E}_{A}_{W}_{R}C_{T}_{T}^{C}_{E}_{I}_{E}O_{H}_{T}^{O}_{S}_{X}_{C}N_{S}^{N}_{S}_{T}_{H}T_{W}_{I}^{T}_{N}_{R}E^{E}_{R}_{I}_{D}_{E}X_{T}^{X}_{E}_{L}T_{C}_{I}^{T}_{Q}_{C}_{E}_{H}R^{R}_{A}_{U}_{A}E^{E}_{T}_{R}_{S}_{E}S_{I}_{E}^{Q}_{E}_{S}P_{O}^{L}_{Q}_{T}^{U}O_{N}^{a}_{U}^{E}_{R}N^{s}^{S}_{E}_{E}^{t}S^{T}_{S}_{S}^{S}E_{P}_{T}^{e}_{O}^{r}^{v}_{N}^{i}^{n}_{S}^{g}_{E}^{g}^{N}^{B}^{A}^{M}^{F}]
...
![](media_svg/image48.svg) [公式≈: _{S}_{w}_{i}_{t}_{c}_{h}_{t}^{U}_{o}^{E}_{N}_{e}_{3}_{w}_{.}_{R}_{C}_{R}_{e}_{l}_{C}_{l}_{R}_{e}_{c}_{o}_{n}_{f}_{i}_{g}_{u}_{r}_{a}^{S}_{t}_{i}_{o}^{o}_{4}_{n}_{.}^{u}_{R}^{r}^{c}_{R}^{e}_{C}^{g}_{R}2^{N}_{e}._{c}^{B}H_{o}A_{n}_{f}N_{i}_{g}D_{u}O_{r}^{1}_{a}^{.}V_{t}^{H}_{i}E_{o}^{A}R_{n}^{N}_{C}R^{D}_{o}E_{m}^{O}Q_{p}^{V}U_{l}^{E}_{e}E_{t}^{R}_{e}ST^{R}^{E}A^{Q}C^{U}K^{E}N^{S}O^{T}WLE^{A}D^{d}^{T}^{m}G^{a}^{i}E^{s}^{r}^{s}^{g}^{i}^{e}^{o}^{n}^{t}^{g}^{C}^{N}^{o}^{n}^{B}^{t}^{r}^{o}^{l}]
...
![](media_svg/image49.svg) [公式≈: _{S}_{y}_{D}_{n}_{e}_{c}_{t}_{h}_{a}_{r}_{c}_{o}_{1}_{h}_{n}_{.}_{M}_{i}_{f}_{s}^{U}_{r}_{o}_{e}_{e}^{E}_{6}_{m}_{a}_{t}_{.}_{o}_{s}_{R}_{o}_{u}_{n}_{l}_{r}_{A}_{d}_{e}_{e}_{N}_{w}_{m}_{c}_{e}_{e}_{H}_{c}^{U}_{l}_{n}_{l}_{e}_{a}^{s}_{t}_{l}_{n}_{l}^{e}_{C}_{d}^{r}_{o}_{o}^{D}_{a}_{n}_{v}_{n}^{a}_{t}_{e}_{r}_{2}_{d}^{t}_{D}_{8}_{r}_{o}^{a}_{.}_{.}_{l}_{I}_{e}_{n}_{H}_{n}_{R}_{a}_{l}_{e}_{i}^{S}_{i}_{a}_{v}_{n}_{t}_{w}_{A}_{i}_{e}_{n}^{o}_{a}_{d}_{N}_{r}_{d}_{t}_{d}^{u}_{i}_{R}_{o}_{o}_{b}_{a}_{H}^{r}_{e}_{n}_{v}_{u}_{t}^{c}_{a}_{a}_{U}_{e}_{p}_{f}^{e}_{f}_{n}_{r}_{o}_{e}_{f}_{s}_{r}_{d}^{g}_{r}_{D}_{r}_{e}_{o}_{t}_{1}_{e}_{o}^{N}_{s}_{r}_{8}_{m}_{8}_{e}_{7}_{3}_{5}_{d}_{v}_{2}_{b}_{D}_{c}_{a}^{B}_{e}_{.}_{.}_{.}_{.}_{d}_{U}_{.}_{i}_{.}_{a}_{r}_{s}_{S}_{H}_{H}_{U}_{a}_{S}_{H}_{t}_{P}_{7}_{i}_{C}_{N}_{o}_{a}_{t}_{A}_{A}_{A}_{N}_{E}_{a}_{a}_{F}_{n}_{A}_{o}_{N}_{N}_{C}_{.}_{S}_{(}_{m}_{C}_{S}_{N}_{s}_{E}_{T}_{D}_{D}_{K}_{T}_{)}_{O}_{p}_{D}_{T}_{A}_{A}_{N}_{A}_{O}_{O}_{l}0_{R}_{e}_{N}_{O}_{T}_{R}_{T}._{O}_{V}_{V}_{t}_{A}M_{U}_{T}_{i}_{L}_{V}_{o}_{U}_{E}_{E}_{W}_{N}_{E}_{Y}o_{S}_{n}_{E}_{S}_{R}_{R}b_{S}_{X}_{L}_{R}_{S}_{T}i_{E}_{T}_{T}l_{E}_{R}_{R}_{T}i_{R}t_{S}_{R}_{R}_{D}y_{A}_{E}_{E}_{R}_{A}_{U}_{A}_{T}_{Q}_{Q}c_{G}_{E}_{N}_{C}_{N}o_{U}_{L}_{4}_{U}_{U}_{E}_{S}n_{C}_{S}_{.}_{S}_{E}_{F}_{f}t_{E}_{E}_{B}_{F}_{r}r_{E}_{A}_{A}_{E}_{o}o_{S}_{S}_{u}_{E}^{T}_{d}_{S}_{m}l_{S}_{R}_{f}_{T}_{T}_{m}^{a}_{R}_{S}_{f}i_{E}_{e}n^{r}_{S}_{i}_{r}f^{g}_{s}o_{o}_{U}_{s}^{e}r_{u}_{i}m_{s}_{o}^{t}_{r}_{e}_{n}_{c}a^{g}_{r}_{e}t_{1}^{N}_{C}i_{E}_{9}_{D}o^{U}_{U}_{U}_{1}_{g}_{o}^{B}_{.}_{n}n_{a}_{.}_{N}^{s}_{s}_{s}_{n}_{P}_{d}_{t}_{P}p^{e}_{e}_{e}_{a}_{B}_{t}_{A}_{r}_{M}r^{r}_{r}_{r}_{A}_{o}o_{T}_{A}^{D}_{D}_{D}_{l}_{a}_{T}v_{H}_{C}^{a}_{a}_{a}_{r}i_{H}d_{k}^{t}_{t}_{t}_{K}e^{a}_{a}_{a}_{e}_{S}_{S}d_{r}_{N}_{W}_{W}b_{O}_{I}_{I}y_{T}_{W}_{T}_{C}A_{C}_{L}M_{H}_{H}_{E}_{U}_{U}F_{R}_{D}_{R}_{s}_{s}_{E}_{G}_{e}_{e}_{E}_{r}_{Q}_{r}_{E}_{Q}_{D}_{D}_{U}_{U}_{a}_{a}_{E}_{t}_{t}_{E}_{a}_{a}_{S}_{S}_{T}_{1}_{T}_{0}^{A}_{.}^{M}_{P}_{a}^{F}_{t}_{h}_{S}_{w}_{i}_{t}_{c}_{h}_{i}_{n}^{U}_{U}^{P}_{P}^{F}_{F}^{(}^{s}_{(}_{s}^{)}_{)}]
...
![](media_svg/image50.svg) [公式≈: ^{U}^{E}^{i}^{C}^{n}^{M}^{R}^{-}^{R}^{C}^{C}^{O}^{_}^{U}^{N}^{C}^{N}^{E}^{O}^{E}^{N}4_{5}^{C}^{N}a_{a}^{1}^{T}._{.}^{E}^{.}^{E}R_{R}^{R}^{C}^{D}R_{R}^{4}^{R}^{5}^{T}^{.}^{.}C_{C}^{E}^{C}^{R}^{R}^{D}R_{R}^{R}^{R}^{R}e_{e}^{e}^{C}^{C}e_{c}^{e}s_{o}^{s}^{R}^{R}t^{t}_{n}a^{a}^{e}^{e}_{f}b^{e}^{c}^{b}_{i}_{g}^{s}l^{o}^{l}i^{i}^{t}_{u}^{n}s^{s}^{a}_{r}h^{h}^{f}^{b}^{i}_{a}m^{m}^{g}^{l}_{t}^{i}^{u}_{i}e^{s}^{e}_{o}^{r}^{h}n^{n}_{n}^{a}^{m}t^{t}_{C}C^{R}^{t}^{i}^{e}^{o}_{o}o^{e}^{n}^{q}^{n}_{m}m^{t}^{u}_{p}p^{e}_{l}l^{s}_{e}e^{t}_{t}t_{e}e^{g}^{N}^{B}^{3}^{2}^{.}^{.}^{R}^{R}_{6}^{E}^{E}_{.}^{T}^{T}_{1}_{X}^{R}_{9}_{7}_{0}^{R}_{N}_{.}^{I}_{.}_{.}^{I}^{E}_{P}_{-}^{E}_{S}_{U}_{U}^{V}_{A}_{N}^{V}_{E}^{E}_{T}_{A}^{E}_{8}_{S}_{H}_{C}_{D}^{U}_{.}_{T}^{U}_{O}_{P}_{A}_{D}^{E}_{S}^{E}_{A}_{N}_{W}_{T}_{R}^{C}_{T}_{U}^{C}_{T}_{E}_{I}^{O}_{H}_{T}_{E}^{O}_{S}_{S}_{C}^{N}_{X}_{S}^{N}_{S}_{T}_{H}_{T}^{T}_{W}_{R}_{I}^{T}^{E}_{N}_{R}^{E}_{A}_{R}_{I}^{X}_{D}_{T}_{E}^{X}_{N}_{E}^{T}_{C}_{I}_{L}^{T}_{S}_{Q}_{C}_{H}_{E}^{R}_{F}^{R}_{U}_{A}_{A}^{E}_{E}^{E}_{R}_{T}_{E}_{S}^{S}_{R}^{Q}_{E}_{I}_{S}_{E}^{P}_{O}^{L}_{Q}_{T}^{U}^{O}_{N}^{a}_{U}^{E}_{R}^{N}^{s}^{S}_{E}_{E}^{t}^{S}^{T}_{S}_{S}^{S}^{E}_{P}_{T}^{e}_{O}^{r}^{v}_{N}^{i}^{n}_{S}^{g}_{E}^{g}^{N}^{B}^{A}^{M}^{F}]
...
![](media_svg/image51.svg) [公式≈: E_{s}v_{y}a_{D}_{n}l_{e}u_{c}_{t}_{h}a_{a}_{r}t_{c}e_{o}_{h}_{n}th_{i}_{f}_{z}_{r}e_{e}_{o}_{m}^{U}C_{t}_{o}H^{E}_{t}_{t}_{h}O^{1}_{h}_{e}^{7}^{.}_{e}^{M}c^{.}_{o}_{n}o^{R}^{e}_{l}_{d}_{e}n^{a}^{R}_{w}d^{6}^{s}_{c}^{C}i^{.}^{u}_{e}t_{c}i^{R}^{R}^{r}o_{l}_{e}_{l}^{e}_{,}n^{e}^{R}_{l}^{m}_{l}s^{c}_{.}^{C}.^{o}^{e}^{U}^{R}^{n}^{n}^{s}^{t}^{f}^{e}^{i}^{e}^{c}^{C}^{g}^{r}^{o}^{u}^{o}^{D}^{n}^{r}^{n}^{f}^{a}^{a}^{t}^{i}^{r}_{8}^{t}^{t}^{g}^{o}^{a}^{i}_{.}^{u}^{o}^{l}_{C}^{r}^{n}^{a}^{a}_{H}^{n}^{C}^{t}^{d}_{O}^{i}^{o}^{o}^{m}^{R}^{n}_{H}^{2}^{e}^{p}_{a}^{.}^{S}^{p}^{l}_{n}^{e}^{C}^{o}^{o}_{d}^{t}^{r}^{H}^{e}^{u}^{t}_{o}^{s}^{O}^{r}_{v}^{c}_{e}^{D}^{e}_{r}^{e}_{c}^{g}_{o}^{c}_{8}^{5}_{8}^{N}^{3}^{5}_{8}^{i}_{m}_{F}_{b}^{.}^{s}_{a}^{.}^{.}_{c}^{B}_{i}^{i}_{.}^{H}_{p}_{.}_{g}^{o}_{.}^{H}^{H}_{S}_{l}_{H}_{u}^{n}^{A}_{e}_{H}^{A}^{A}^{A}_{N}_{r}_{t}_{A}^{N}_{e}_{i}_{A}^{N}^{N}^{C}_{o}7^{0}_{S}_{N}^{D}_{N}_{9}_{n}a^{D}^{D}^{K}^{.}_{T}_{D}_{.}^{M}.^{O}_{D}^{3}_{2}^{N}_{A}^{O}^{O}E_{.}_{O}^{.}^{o}^{V}_{O}_{3}_{T}^{O}^{V}^{V}A^{H}^{b}_{V}_{.}^{E}_{U}_{V}_{2}^{E}^{E}^{i}^{W}R^{l}^{A}_{E}^{R}^{i}_{.}_{E}_{S}^{t}^{R}^{R}_{1}L^{y}^{N}^{L}_{R}_{R}_{-}^{R}Y_{T}^{E}_{1}^{R}^{R}^{c}^{D}_{S}^{E}_{R}^{o}_{C}^{D}S^{E}^{E}_{s}^{O}_{U}^{n}^{Q}_{A}T_{t}_{A}^{Q}^{Q}^{G}_{e}^{t}^{V}_{C}_{N}A^{r}^{U}^{4}_{N}_{p}^{U}^{U}^{o}^{E}^{E}^{.}_{C}T_{S}^{E}^{l}_{C}_{9}^{E}^{E}^{A}^{R}_{F}U^{i}_{E}^{S}^{n}_{-}_{E}^{T}^{d}^{S}^{S}_{1}_{E}_{S}^{T}S^{f}^{R}_{L}^{m}^{a}^{T}^{T}^{o}_{2}_{R}_{S}^{E}^{r}^{r}T^{A}^{i}^{m}^{g}^{s}^{U}_{U}_{U}^{Q}R^{C}^{s}^{e}^{a}^{s}_{s}_{s}A^{U}^{i}^{K}^{o}^{t}^{t}^{e}_{e}_{e}^{i}N^{n}^{o}^{E}^{N}^{r}_{r}_{r}^{g}^{n}S^{D}_{D}_{D}^{S}^{N}^{C}^{O}F^{T}^{p}^{a}_{a}_{a}^{o}^{B}^{W}E^{r}^{t}_{t}_{t}^{n}^{a}^{o}_{a}_{a}R^{t}^{L}^{v}^{r}^{4}^{o}^{E}^{i}^{d}^{.}^{l}^{O}^{D}^{e}^{A}^{t}^{a}^{d}^{t}^{d}^{G}^{h}^{r}^{m}^{b}^{g}^{E}^{e}^{y}^{i}^{r}^{e}^{s}^{A}^{t}^{s}^{p}^{i}^{M}^{g}^{o}^{o}^{N}^{n}^{t}^{F}^{e}^{B}^{C}^{n}^{(}^{o}^{t}^{s}^{i}^{n}^{a}^{)}^{t}^{r}^{l}^{o}^{l}^{A}^{M}^{F}^{U}^{P}^{F}^{(}^{s}^{)}]
...
![](media_svg/image56.svg) [公式≈: _{gNB beam 1}_{gNB beam 2}_{gNB beam }_{K}_{A}UE Implementation UE Implementation _{L}_{L}_{L}_{Physical Layer}_{ayer}_{ayer}_{ayer}_{K beams }_{specific}_{specific}_{1 filter}_{1 filter}_{1 filter}_{ing}_{ing}_{ing}_{B}_{B}_{1}_{Evaluation of }^{RRC configures }_{MAC Layer}^{parameters}_{reporting }_{criteria}_{reporting}_{MAC CE }_{C}]
...
![](media_svg/image57.svg) [公式≈: ^{U}^{E}_{6}_{.}5_{P}._{E}A^{1}r_{I}^{.}r^{U}i_{a}v_{n}a^{E}_{d}l/_{/}g^{s}_{o}^{u}e_{r}^{p}^{3}n_{L}^{p}^{.}e^{o}^{S}r_{P}a^{r}^{u}_{-}t^{t}_{W}^{b}io^{o}^{g}n_{U}^{f}^{r}^{o}o^{C}_{S}f^{u}^{N}^{g}p^{p}^{N}a^{c}^{I}g^{B}^{o}^{D}i^{n}n^{4}^{a}^{t}g^{r}^{.}^{s}^{o}m^{A}^{s}^{l}^{i}^{s}^{l}e^{g}^{e}^{s}s^{n}^{d}^{i}s^{g}^{m}a^{s}^{n}^{e}^{u}g^{e}^{n}e^{b}^{d}^{t}^{g}f^{s}o^{r}^{u}^{2}^{o}r^{b}^{.}^{u}th^{g}^{U}^{p}e^{r}^{i}^{E}^{o}^{n}U^{u}^{g}^{s}E^{p}^{u}^{b}^{I}^{g}^{D}^{r}^{o}^{A}^{u}^{M}^{p}^{F}^{d}^{e}^{t}^{e}^{r}^{m}^{i}^{n}^{a}^{t}^{i}^{o}^{n}]
...
![](media_svg/image58.svg) [公式≈: _{3}_{.}_{U}_{E}_{s}_{u}_{b}_{g}_{r}_{o}_{u}^{U}_{p}^{E}_{d}_{e}2_{t}._{e}T_{r}_{m}he_{i}_{n}t_{a}o_{t}_{i}t_{o}a_{n}ln_{i}u_{s}m_{b}b_{r}e_{o}r_{a}_{d}_{5}o_{c}_{.}f_{a}_{P}s_{s}u_{E}_{t}b_{e}_{I}g_{d}_{a}r_{i}_{n}o_{n}_{d}u_{S}_{/}p_{o}_{y}s_{r}_{s}f_{t}_{L}o_{e}r_{P}_{m}U_{-}_{W}_{I}E_{n}_{U}_{f}_{o}I_{4}_{S}D_{r}^{1}_{.}_{m}^{.}_{A}b_{a}^{N}a_{r}_{t}_{r}^{W}s_{i}_{i}_{v}_{o}e_{a}d_{n}^{d}_{l}_{/}^{e}s_{g}u^{t}_{e}^{e}b_{n}^{r}g^{m}_{e}r_{r}^{i}o_{a}^{n}u_{t}^{e}_{i}_{o}p^{s}_{n}i^{t}n^{h}_{o}g^{e}_{f}^{g}_{p}^{t}^{o}^{N}_{a}^{t}_{g}^{a}^{B}_{i}^{l}_{n}^{n}_{g}^{u}_{m}^{m}_{e}^{b}_{s}^{e}_{s}^{r}_{a}^{o}_{g}^{f}_{e}^{s}^{u}_{f}_{o}^{b}_{r}^{g}_{t}^{r}_{h}^{o}_{e}^{u}^{p}_{U}^{s}_{E}]
...
![](media/image59.emf)      ![](media/image60.emf)

(a) CBRA with 4-step RA type      (b) CBRA with 2-step RA type

![](media/image61.emf)      ![](media/image62.emf)
...
![](media_svg/image70.svg) [公式≈: Gl^{P}o^{C}^{h}b^{y}a^{e}^{-}l-^{C}^{l}C^{l}^{I}^{D}ID^{A}^{=}=^{3}1_{2}7_{.}_{(}_{3}_{P}_{R}_{.}_{h}_{e}_{R}_{y}_{(}_{p}_{T}_{e}_{-}_{o}_{C}_{p}_{a}_{r}_{r}_{o}_{t}_{I}_{g}_{D}_{r}_{G}_{e}_{1}_{t}_{=}_{t}_{l}_{.}_{G}_{o}_{5}_{P}_{R}_{b}_{l}_{,}_{h}_{o}_{e}_{a}_{s}_{y}_{p}_{b}_{l}_{t}_{-}_{-}_{r}_{o}_{a}_{C}_{C}_{o}_{r}_{l}_{-}_{n}_{t}_{I}_{I}_{C}_{D}_{D}_{g}_{I}_{=}_{s}_{D}_{R}_{i}_{5}_{g}_{e}_{=}_{)}_{n}_{q}_{1}_{a}_{u}_{9}_{l}_{e}_{)}_{s}_{t}^{U}^{E}_{2}_{b}_{.}_{B}_{C}_{C}_{H}_{(}_{.}_{.}_{.}_{)}Gl^{P}o^{C}^{h}b^{y}a^{e}^{-}l-^{C}^{l}C^{l}^{I}^{D}ID^{B}^{=}=^{5}19]
...
![](media_svg/image71.svg) [公式≈: Gl^{P}o^{T}^{C}^{h}b^{y}^{y}a^{p}^{e}^{-}l^{e}-^{C}^{l}C^{=}^{l}^{I}^{D}I^{N}D^{A}^{=}^{R}=^{3}1_{2}_{3}7_{1}_{.}_{.}_{.}_{4}_{R}_{R}_{R}_{.}_{(}_{e}_{e}_{P}_{R}_{e}_{(}_{p}_{p}_{T}_{p}_{h}_{e}_{(}_{o}_{o}_{a}_{o}_{R}_{y}_{p}_{r}_{r}_{-}_{r}_{r}_{t}_{o}_{A}_{t}_{C}_{g}_{t}_{r}_{N}_{G}_{T}_{e}_{N}_{I}_{t}_{,}_{e}_{D}_{t}_{l}_{G}_{e}_{o}_{i}_{F}_{P}_{g}_{,}_{i}_{b}_{l}_{g}_{r}_{h}_{h}_{S}_{o}_{a}_{e}_{h}_{y}_{b}_{i}_{b}_{l}_{q}_{g}_{b}_{-}_{-}_{o}_{a}_{u}_{C}_{C}_{n}_{o}_{u}_{l}_{e}_{-}_{a}_{u}_{I}_{I}_{r}_{C}_{n}_{D}_{D}_{l}_{r}_{R}_{c}_{I}_{L}_{R}_{=}_{y}_{D}_{R}_{e}_{e}_{e}_{)}_{5}_{s}_{v}_{e}_{=}_{q}_{p}_{)}_{e}_{q}_{u}_{1}_{o}_{l}_{u}_{e}_{9}_{n}_{e}_{s}_{s}_{s}_{t}_{e}_{t}^{U}^{E}_{3}_{b}_{.}_{B}_{C}_{C}_{H}_{(}_{.}_{.}_{.}_{)}^{P}G^{h}^{y}l^{T}o^{-}^{C}b^{C}^{y}^{p}a^{I}^{e}^{D}^{e}l-^{l}^{=}C^{=}^{l}^{L}^{P}ID^{B}^{T}^{S}=^{E}^{C}1^{=}9^{5}]
...
![](media_svg/image73.svg) [公式≈: ^{U}^{E}UL/DLbitraterecommendation^{g}^{N}^{B}]
...
![](media_svg/image74.svg) [公式≈: ^{U}^{E}UL/DLbitraterecommendationquery^{g}^{N}^{B}]
...
![](media_svg/image75.svg) [公式≈: ^{U}^{E}^{(}^{T}^{R}^{e}^{R}^{m}^{C}^{p}^{(}^{C}^{I}^{D}^{o}^{n}^{o}^{n}^{p}^{e}^{t}^{c}^{i}^{o}^{t}^{i}^{n}^{o}^{a}i^{n}d^{l}^{)}^{,}e^{S}^{N}n^{e}t^{S}^{t}if^{u}y^{S}^{p}^{A}C^{C}N^{I}^{o}_{o}^{o}n^{m}_{r}^{p}o^{i}_{s}^{t}^{d}^{p}d^{i}_{e}^{e}^{l}^{o}e_{l}^{e}_{e}^{n}^{n}^{t}s^{t}_{c}^{e}^{a}^{i}u^{f}_{t}^{l}^{y}^{)}p_{d}^{g}^{s}p_{e}^{l}o_{f}^{N}^{i}_{a}^{c}r^{B}^{e}t_{u}in_{l}_{t}^{p}^{(}g^{L}_{C}^{o}^{(}c^{l}^{i}_{N}^{L}^{i}^{s}^{c}o^{t}^{i}^{i}n_{n}^{e}^{s}^{o}c_{o}^{t}^{s}^{f}e_{d}^{o}r^{S}_{e}^{(}^{f}n^{L}^{N}_{I}^{-}e^{S}^{N}^{(}_{N}^{N}^{i}^{G}^{L}d^{-}^{s}^{G}_{I}^{N}^{S}^{t}^{i}_{T}s^{s}^{S}^{S}^{o}l^{S}^{S}_{I}^{t}i^{E}c^{A}^{f}_{A}^{E}^{S}^{o}e^{T}^{S}_{L}^{A}^{I}^{f}^{T}(^{(}^{U}^{N}^{-}s^{U}^{S}^{N}^{s}^{I}_{U}^{N})^{G}^{(}^{)}^{P}^{-}^{G}^{P}^{s}_{E}^{N}^{S}^{s}^{)}^{R}^{S}^{u}^{S}^{R}^{S}^{S}_{M}^{s}^{E}^{p}^{E}^{A}^{u}^{E}^{S}^{E}^{p}^{T}^{S}_{E}^{p}^{A}^{I}^{T}^{Q}^{o}^{P}^{(}^{U}^{p}_{S}^{U}^{s}^{r}^{I}^{U}^{o}^{O}_{S}^{t}^{(}^{)}^{P}^{e}^{P}^{s}^{r}_{A}^{E}^{s}^{N}^{t}^{d}^{)}^{R}^{e}^{u}_{G}^{S}^{R}^{S}^{s}^{d}^{p}^{p}^{E}^{T}^{u}_{E}^{E}^{E}^{e}^{p}^{S}^{p}^{p}^{Q}^{r}^{o}^{P}^{e}^{p}^{P}^{r}_{a}^{U}^{r}^{o}^{O}^{t}_{n}^{L}^{e}^{T}^{r}^{E}_{v}^{N}_{d}^{t}^{d}^{M}_{a}^{A}^{e}^{S}^{S}_{s}_{l}^{d}^{p}^{T}_{i}^{)}^{N}^{E}_{d}_{l}^{e}_{i}^{p}_{c}_{a}^{r}^{)}^{A}_{e}^{e}_{t}^{P}_{e}_{(}^{r}^{M}_{s}^{L}^{T}_{U}_{)}^{F}_{a}^{M}^{A}_{E}_{v}^{1}_{a}^{)}^{N}_{r}_{i}_{i}_{g}_{l}^{)}_{a}_{h}_{b}_{t}_{s}_{i}_{l}_{i}_{t}_{y}^{A}^{M}^{F}^{2}]
...
![](media_svg/image76.svg) [公式≈: Pre^{U}c^{E}onditions:RR_{U}_{p}C_{o}_{E}_{l}_{i}C_{c}_{s}_{i}_{l}o_{e}_{i}_{c}n_{s}_{e}n_{u}e_{a}_{p}c_{c}^{g}_{d}t_{c}i_{a}o^{N}_{e}_{t}n_{s}_{e}^{B}_{s}_{d}E_{(}_{c}s_{i}_{A}_{f}_{o}ta_{n}_{l}_{n}_{l}b_{e}_{f}_{o}_{i}l_{r}_{e}i_{w}_{m}s_{d}h_{e}_{e}_{e}m_{d}_{d}_{d}e_{N}n_{S}_{I}t_{I}_{N},_{S}_{N}A_{I}_{A}_{I}_{T}M_{T}_{I}_{I}_{I}F_{,}_{A}_{A}_{o}_{L}I_{L}n_{n}s_{C}_{e}_{C}t_{O}a_{S}_{O}n_{-}_{N}_{N}c_{N}_{T}e_{T}_{S}_{E}S_{E}_{S}_{X}^{A}e_{A}_{X}_{T}l^{M}e_{T}_{I}c_{S}^{F}_{p}_{S}t_{E}i_{e}^{1}_{E}o_{r}_{T}n_{T}_{P}_{U},_{U}_{D}P_{P}_{P}r_{U}o_{R}_{R}v_{E}_{S}i_{E}s_{e}_{S}i_{Q}o_{s}_{P}_{s}n_{U}_{O}_{i}a_{o}_{E}l_{N}_{n}p_{S}_{S}o_{w}_{T}_{E}li_{h}c_{e}ie_{n}s_{p}m_{r}_{e}a_{s}y_{e}b_{n}e_{t}_{)}^{A}a^{M}pp^{F}li^{2}ed]
...
![](media_svg/image77.svg) [公式≈: Pre^{U}c^{E}ondition:UEContextisest_{r}a_{e}_{g}_{N}b_{s}_{i}_{v}_{G}l_{o}i_{e}s_{u}_{-}_{n}h_{R}_{r}e_{c}_{A}_{N}_{e}d_{N}_{e}_{s}_{e}i_{t}n_{s}_{w}_{c}_{v}_{t}_{a}_{e}N_{a}_{o}_{n}_{r}_{b}_{r}G_{i}^{g}_{k}_{f}_{l}_{b}_{i}_{i}^{N}-_{e}_{s}_{S}R_{e}_{h}_{s}^{B}_{l}A_{i}_{m}_{e}_{c}_{P}N_{s}_{P}_{e}_{e}_{D}_{P}_{t}_{a}_{D}_{n}_{(}_{U}_{D}_{i}_{b}_{t}_{n}_{U}_{)}_{l}_{U}_{s}_{i}_{s}_{c}_{e}_{S}_{h}_{a}_{S}_{s}_{E}_{e}_{s}_{E}_{s}_{(}_{e}_{d}_{S}_{i}_{o}_{S}_{o}_{S}_{o}_{f}_{n}_{S}_{n}_{o}_{I}_{f}_{e}_{I}_{O}_{r}_{O}_{S}_{N}_{N}_{-}_{N}_{R}_{R}_{S}_{E}_{E}_{S}_{S}_{S}_{A}_{O}_{O}^{A}_{I}_{U}_{U}^{M}_{p}_{R}_{R}_{e}^{F}_{C}_{r}_{C}^{1}_{E}_{P}_{E}_{D}_{S}_{S}_{U}_{E}_{E}_{T}_{T}_{S}_{U}_{U}_{e}_{P}_{s}_{P}_{s}_{i}_{R}_{o}_{R}_{E}_{n}_{E}_{)}_{S}_{Q}_{P}_{U}_{O}_{E}_{N}_{S}_{S}_{T}_{E}^{A}^{M}^{F}^{2}]
...
![](media_svg/image78.svg) [公式≈: ^{a}^{n}^{U}^{n}^{s}^{E}^{d}^{l}^{i}^{i}^{c}^{w}^{n}^{e}^{i}^{t}^{s}^{R}^{h}^{R}^{c}^{m}^{o}^{C}^{n}^{_}^{P}^{f}^{i}^{C}^{D}^{g}^{u}^{U}^{O}^{U}^{r}^{E}^{N}^{e}^{s}^{d}^{N}^{e}^{s}^{E}^{a}^{s}^{t}^{C}^{i}^{N}^{o}^{T}R^{n}^{A}^{E}e^{s}^{S}^{D}g^{a}is^{l}^{c}^{w}^{e}t^{t}^{v}r^{i}^{i}^{t}^{v}a^{e}^{h}^{e}t^{H}^{l}i^{H}o^{a}^{t}n^{a}^{i}^{o}^{n}^{n}^{n}A^{d}^{R}^{g}^{d}^{o}r^{e}^{N}^{o}e^{g}^{v}^{v}^{B}^{i}a^{g}^{e}^{s}^{e}^{t}^{2}^{r}^{N}^{r}U^{r}^{a}^{p}^{t}^{t}^{B}^{E}p^{i}^{r}^{r}^{o}^{i}d^{e}^{x}^{n}^{1}^{g}a^{p}^{e}^{g}^{A}t^{a}^{c}^{e}^{r}e^{e}^{u}^{r}^{r}^{a}^{a}^{e}(^{t}^{i}a^{t}^{1}^{d}^{o}^{i}^{o}l^{n}ig^{n}nmento^{i}^{n}f^{R}s^{e}l^{g}ic^{i}^{g}^{s}e^{t}^{N}^{r}s^{a}^{t}^{B}s^{i}^{o}u^{n}^{2}^{H}^{H}p^{(}^{A}^{A}p^{r}^{A}^{A}^{e}o^{l}^{a}^{N}^{N}^{l}^{H}r^{(}^{o}t^{2}^{D}^{L}^{D}e^{w}^{A}d^{i}^{O}^{O}^{N}^{s}^{e}i^{t}^{d}^{V}n^{V}^{D}^{o}^{E}^{E}^{N}t^{O}^{f}h^{R}^{R}^{S}^{a}e^{V}^{c}^{H}^{S}^{C}^{R}^{E}n^{c}^{A}^{A}e^{E}^{O}^{R}^{e}w^{p}^{N}^{I}^{Q}^{M}^{,}^{R}^{t}^{D}^{e}R^{U}^{o}^{E}^{M}^{d}^{n}^{O}A^{I}^{Q}^{e}^{R}^{A}^{a}^{V}b^{U}^{n}^{E}^{N}^{S}e^{E}^{d}^{E}^{D}^{-}^{D}t^{R}w^{N}^{S}^{f}^{a}e^{T}^{S}^{R}^{i}e^{l}^{S}^{E}^{A}^{e}n^{A}^{Q}^{d}^{C}U^{I}^{U}^{P}^{K}E^{p}^{D}^{E}^{N}^{e}a^{U}^{S}^{r}^{O}n^{T}^{P}d^{W}^{S}^{D}N^{e}^{L}^{U}^{s}e^{E}^{s}t^{i}w^{D}^{S}^{o}o^{e}^{n}^{G}r^{s}^{s}k^{E}^{s}^{)})^{i}^{o}^{n}^{)}^{A}^{M}^{F}]

Figure 16.3.4.5-1: NG based mobility across different Registration Areas

![](media_svg/image79.svg) [公式≈: ^{a}^{n}^{U}^{n}^{s}^{E}^{d}^{l}^{i}^{i}^{c}^{w}^{n}^{e}^{i}^{t}^{s}^{R}^{h}^{R}^{c}^{m}^{o}^{C}^{a}^{n}^{_}^{P}^{t}^{f}^{i}^{C}^{D}^{g}^{A}^{u}^{U}^{O}^{U}^{S}^{r}^{E}^{N}^{e}^{l}^{s}^{e}^{d}^{N}^{e}^{v}^{s}^{E}^{a}^{e}^{s}^{t}^{C}^{l}^{i}^{N}^{o}^{T}^{n}^{A}^{E}^{s}^{S}^{D}^{a}^{l}^{c}^{w}^{e}^{t}^{v}^{i}^{i}^{t}^{v}^{e}^{h}^{P}^{e}^{S}^{l}^{r}^{l}^{e}^{i}^{t}^{c}^{i}^{o}^{p}^{n}^{e}^{a}^{R}^{g}^{A}R^{r}^{e}^{N}^{a}^{g}^{w}e^{t}^{B}^{i}^{g}^{s}^{i}g^{a}^{o}^{t}^{2}^{N}^{r}i^{r}^{n}^{a}s^{e}^{t}^{t}^{B}t^{i}^{r}^{f}^{o}r^{i}^{H}^{r}a^{n}^{1}^{g}^{o}t^{(}^{a}^{g}^{A}^{m}i^{L}o^{n}^{e}^{r}^{e}n^{i}^{d}^{r}^{g}^{a}^{H}^{s}^{e}^{H}^{o}^{t}A^{N}^{1}^{d}^{a}^{v}^{A}^{o}r^{B}^{n}^{e}e^{f}^{N}^{d}^{1}^{r}a^{a}^{o}^{D}^{(}^{d}U^{v}^{o}^{O}^{m}^{e}^{n}p^{r}^{V}d^{e}^{i}^{H}^{E}^{t}a^{E}^{t}^{S}t^{x}^{e}^{A}^{R}e^{-}^{e}^{d}^{N}^{N}^{c}(^{R}^{a}a^{u}^{S}^{D}^{n}^{E}l^{t}^{S}i^{i}g^{O}^{d}^{o}^{Q}^{A}n^{n}^{V}^{n}^{U}m^{I}^{o}^{E}^{p}^{E}e^{n}^{R}^{e}n^{S}^{a}^{r}t^{T}^{R}^{d}o^{P}^{E}^{m}^{A}f^{D}^{Q}s^{C}^{i}^{U}^{t}li^{U}^{t}^{K}c^{e}e^{S}^{E}^{N}^{d}s^{e}^{S}^{O}^{P}^{s}s^{T}^{s}^{D}^{W}u^{i}p^{o}^{U}^{L}p^{n}^{E}o^{)}^{S}r^{D}^{e}te^{s}^{G}d^{A}^{s}^{i}^{i}^{n}^{E}^{d}^{o}in^{R}^{m}^{n}^{S}^{e}t^{s}^{i}^{l}h^{g}^{s}^{i}^{)}^{c}^{i}^{g}e^{s}^{s}^{e}^{t}^{i}^{N}^{r}^{o}n^{a}^{A}^{t}^{n}^{B}e^{i}^{o}^{w}w^{n}^{2}^{C}^{a}^{P}^{A}^{(}^{o}R^{r}^{L}^{r}^{A}^{(}^{e}^{n}^{e}A^{L}^{i}^{a}^{t}^{T}^{s}^{r}^{i}b^{2}^{o}^{H}^{t}^{s}e^{l}^{t}^{o}t^{S}^{o}^{f}w^{W}^{f}^{s}e^{w}^{P}^{a}e^{I}^{c}^{T}^{A}n^{i}^{c}^{t}^{C}^{T}^{c}U^{e}^{h}^{H}^{H}^{p}^{A}E^{e}^{t}^{e}^{d}^{l}^{S}^{R}a^{l}^{d}^{W}^{o}n^{E}^{a}^{w}d^{a}^{n}^{Q}^{I}^{n}^{d}^{T}^{e}N^{U}^{d}^{d}^{C}^{r}e^{e}^{E}^{f}^{H}t^{N}^{a}^{l}w^{S}^{e}^{i}^{S}o^{T}^{l}^{a}^{R}^{e}^{S}r^{s}^{E}k^{d}^{A}^{e}^{A})^{Q}^{d}^{C}^{P}^{I}^{U}^{)}^{D}^{P}^{K}^{D}^{E}^{N}^{U}^{S}^{U}^{O}^{S}^{T}^{W}^{e}^{S}^{s}^{e}^{L}^{s}^{s}^{i}^{E}^{s}^{o}^{i}^{D}^{n}^{o}^{s}^{G}^{n}^{)}^{s}^{E}^{,}^{A}^{M}^{F}]
...
![](media_svg/image80.svg) [公式≈: dif_{5}f^{3}e_{.}^{a}r_{U}e^{.}_{E}n^{U}c_{p}^{E}e_{e}^{U}^{R}m_{r}_{f}_{o}^{x}^{E}e^{-}_{r}a^{T}_{m}s^{x}_{4}_{s}u_{.}^{t}r_{P}^{i}e^{m}_{g}_{D}m_{N}^{e}^{1}_{C}e_{B}^{.}n^{U}_{R}t^{E}_{x}_{-}^{m}_{T}_{x}^{e}^{2}^{a}_{t}_{i}^{a}^{s}_{m}^{u}^{.}^{r}_{e}^{T}^{2}^{e}^{R}^{b}_{d}^{m}^{.}^{S}_{i}_{f}^{e}^{S}_{f}^{o}^{n}_{e}^{R}^{r}_{r}^{t}^{S}_{e}^{c}^{P}_{n}^{o}^{R}_{c}^{n}_{e}^{S}^{f}^{i}_{m}^{g}^{u}_{e}^{r}_{a}^{a}_{s}^{t}d_{u}^{i}^{o}i_{r}f^{3}_{e}f^{n}e_{m}^{b}r^{.}e_{e}^{g}n_{n}^{N}c_{t}e^{B}^{g}m^{R}^{N}e^{x}^{B}a^{-}^{T}s^{x}ur^{t}e^{i}^{m}m^{e}ent]
...
![](media_svg/image81.svg) [公式≈: diff^{3}e^{a}re^{.}n^{U}c^{E}e^{U}^{R}m^{x}^{E}e^{-}a^{T}s^{x}_{4}u_{.}^{t}r^{i}e^{m}_{U}m^{e}_{E}en_{R}^{1}t_{x}^{.}_{-}^{U}_{T}_{x}^{E}_{t}_{i}^{m}_{m}^{e}_{e}^{2}^{a}^{a}_{d}^{s}^{u}^{.}_{i}_{f}^{r}^{T}^{2}_{f}^{e}_{e}^{R}^{b}^{m}_{r}^{.}^{S}_{e}^{e}^{S}_{n}^{o}^{n}^{R}_{c}^{r}^{t}_{e}^{S}^{c}^{P}_{m}^{o}^{R}^{n}_{e}^{S}^{f}_{a}^{i}_{s}^{g}_{u}^{u}_{r}^{r}_{e}^{a}_{m}^{t}^{i}_{e}^{o}_{n}^{n}d_{t}if_{r}^{3}fe_{e}^{b}_{5}_{p}r^{.}e_{.}_{o}^{g}n_{g}_{r}^{N}c_{N}_{t}e^{B}_{B}^{g}_{P}m^{R}^{N}_{D}_{p}e^{x}_{e}^{B}_{C}a^{-}_{r}^{T}_{f}s_{o}^{x}u_{r}r_{m}^{t}e^{i}^{m}_{s}m^{e}ent]
...
![](media_svg/image82.svg) [公式≈: R_{2}R_{.}C_{U}_{i}__{n}_{E}I_{f}_{i}N_{o}_{s}_{d}_{r}A_{c}_{e}_{m}_{a}C_{l}_{t}_{o}_{v}_{e}_{a}T_{c}_{a}_{r}_{t}^{U}_{i}_{m}_{k}I_{i}_{o}V_{l}^{E}_{a}_{n}_{R}_{q}_{i}E_{n}_{b}_{u}_{3}_{R}_{u}_{e}/_{l}_{e}_{a}I_{.}_{5}_{p}_{s}_{(}D_{C}_{l}_{R}_{c}_{.}_{d}_{i}_{t}L_{i}_{l}_{f}_{y}_{D}_{a}_{R}_{R}_{o}E_{t}_{t}_{C}_{e}_{c}_{h}_{L}_{e}s_{k}_{s}_{e}_{I}t_{S}_{u}_{n}_{r}a_{q}_{e}_{m}_{e}_{f}t_{u}_{(}_{o}e_{t}_{E}_{e}_{a}_{u}_{T}_{1}_{p}_{l}_{v}_{r}_{f}_{.}_{i}_{o}_{e}_{a}_{t}_{f}_{S}_{y}_{n}_{r}_{o}_{n}_{I}_{t}_{r}_{R}_{i}_{s}_{B}_{n}_{I}_{f}_{R}_{R}_{9}_{e}_{D}_{f}_{o}_{R}_{r}_{C}_{)}_{r}_{s}_{C}_{m}_{_}_{4}_{m}0_{t}_{I}_{_}_{.}_{a}._{e}_{N}_{a}_{r}_{I}_{g}_{t}T_{s}_{q}_{D}_{e}_{u}_{A}_{t}_{N}_{s}_{i}i_{u}_{p}_{s}m_{L}_{a}_{C}_{o}_{B}_{a}_{o}_{E}_{g}_{c}_{n}_{T}e_{l}_{r}_{h}_{i}_{e}_{)}_{d}_{t}_{t}_{I}_{o}_{i}s_{y}_{V}_{a}_{e}_{n}_{r}y^{g}_{n}_{E}_{t}_{g}_{i}_{e}n_{n}_{g}^{N}_{r}_{f}c_{f}_{e}_{o}_{o}_{m}^{B}h_{r}_{r}_{a}r_{i}_{m}_{n}o_{t}_{t}_{h}_{e}n_{a}_{t}_{e}_{h}_{s}i_{t}z_{i}_{e}_{o}_{U}a_{c}_{n}_{l}t_{g}_{E}_{o}io_{N}_{c}n_{k}_{B}]
...
![](media/image126.emf) ![](media/image127.emf)
...
![](media_svg/image135.svg) [公式≈: ^{4}_{s}_{F}^{f}_{t}^{a}_{a}^{.}^{u}_{a}_{u}^{p}_{p}^{D}^{n}_{t}_{n}_{u}^{p}_{p}^{e}^{c}_{c}_{s}^{l}_{l}^{t}^{U}^{t}^{i}_{i}_{t}^{i}^{c}_{c}^{e}_{i}^{o}_{c}_{o}^{E}^{a}_{a}^{r}^{n}_{h}^{m}_{n}^{b}_{b}^{a}_{a}_{a}^{i}_{i}^{i}^{5}^{l}_{l}^{l}_{n}^{n}^{i}_{l}_{i}^{i}6^{t}_{i}_{t}^{t}^{.}_{g}_{t}^{e}^{y}_{y}^{y}_{y}.^{2}_{7}^{R}_{e}^{s}(^{.}_{.}^{R}D^{1}^{3}^{U}_{U}^{.}^{C}e^{.}^{E}_{E}^{U}-^{R}^{R})^{C}_{A}a^{E}^{e}^{R}c_{s}^{a}^{c}^{C}^{C}t_{s}^{o}^{p}i_{i}v^{a}^{R}^{n}^{a}_{s}a^{p}_{t}^{f}^{e}^{b}_{a}t^{i}^{a}^{c}i^{i}^{g}o_{n}^{b}^{l}^{o}^{u}^{i}n_{c}^{i}^{t}^{n}^{r}^{l}^{y}_{e}o^{i}^{f}^{a}^{I}_{I}^{t}^{i}f^{y}^{n}^{t}_{n}^{g}^{i}f^{E}^{f}_{f}^{u}^{o}u^{o}_{o}^{r}^{n}^{n}n^{r}_{r}^{a}^{q}^{C}c^{m}_{m}^{t}t^{u}^{i}^{o}i^{a}_{a}o^{o}^{i}^{m}^{r}^{t}_{t}n^{n}^{i}_{i}^{y}a^{o}^{p}_{o}l^{n}^{l}_{n}i^{e}ty^{t}^{e}^{g}^{N}^{B}]
...
![](media_svg/image136.svg) [公式≈: ^{4}^{.}^{D}^{R}^{B}^{(}^{s}^{)}^{U}^{e}^{E}^{s}^{t}^{a}^{5}^{b}^{.}^{l}^{R}^{i}^{s}^{R}^{h}^{3}^{e}^{C}^{.}^{d}^{R}^{R}_{7}^{e}^{R}_{.}^{c}^{C}_{U}^{o}^{R}^{n}_{P}^{f}^{e}^{i}_{D}^{c}^{g}^{o}_{a}^{u}^{n}_{t}^{r}_{a}^{f}^{a}^{i}^{t}_{(}^{g}^{i}_{Q}^{u}^{o}_{F}^{r}^{n}^{a}_{I}^{C}_{)}^{t}^{i}^{o}^{o}^{1}^{m}^{n}^{.}^{p}^{P}^{l}^{D}^{e}^{t}^{U}^{e}^{g}^{S}^{N}^{e}^{s}^{B}^{s}^{i}6^{o}^{2}.^{n}^{.}P^{P}_{7}^{E}D_{.}^{D}^{s}U_{U}^{t}^{U}^{a}_{P}^{b}S^{S}^{l}_{D}E^{i}^{E}^{s}_{a}S^{h}^{S}_{t}S^{m}_{a}^{S}I^{I}O^{e}_{(}^{O}_{Q}^{n}N^{N}^{t}_{F}^{R}_{I}R_{)}^{R}^{e}E^{E}^{q}S^{u}^{S}O^{e}^{O}^{U}^{s}U^{U}^{P}^{t}R^{F}^{R}C^{C}E^{E}S^{S}E^{E}T^{T}U^{U}P^{P}R^{R}E^{E}S^{Q}P^{U}O^{E}N^{S}S^{T}E^{A}^{M}^{F}]
...
![](media_svg/image137.svg) [公式≈: _{4}_{.}_{M}_{a}_{p}_{p}_{i}_{n}_{g}^{U}_{r}_{u}^{E}_{l}_{e}_{s}_{3}_{.}_{u}_{D}_{p}_{5}_{L}_{d}_{.}_{a}_{P}_{U}_{t}_{e}_{a}_{P}0_{d}_{c}._{D}_{k}P_{e}_{a}D_{t}_{t}_{a}U_{(}_{Q}_{2}_{(}S_{Q}_{F}_{f}_{.}_{o}e_{I}_{U}_{F}_{,}_{r}s_{I}_{s}_{R}s_{t}_{)}_{h}_{e}i_{D}o_{e}_{a}n_{I}_{)}_{n}_{n}a^{g}_{e}_{e}n^{N}_{w}_{x}d^{B}_{i}_{Q}_{s}D_{t}_{1}_{o}_{i}R_{n}_{5}_{.}_{S}_{g}B_{.}_{D}_{U}_{f}(_{D}_{L}_{l}s_{o}_{P})_{R}_{w}_{P}e_{D}_{B}_{a}s_{c}_{a}ta_{k}_{t}_{a}_{e}b_{t}l_{(}i_{Q}s_{(}_{Q}h_{F}e_{F}_{I}d_{)}_{I}_{)}^{U}^{P}^{F}^{A}^{M}^{F}]
...
![](media_svg/image138.svg) [公式≈: _{4}_{.}_{M}_{a}_{p}_{p}_{i}_{n}_{g}^{U}_{r}_{u}^{E}_{l}_{e}_{s}_{5}_{.}_{u}_{R}_{p}_{d}_{R}_{3}_{a}_{C}_{.}_{t}_{e}_{R}_{R}_{d}_{6}_{e}_{R}_{.}_{c}_{C}_{U}_{o}_{R}_{n}_{P}0_{f}_{e}._{i}_{D}_{c}P_{g}_{o}_{a}_{u}D_{n}_{t}_{r}_{2}_{a}U_{f}_{a}_{i}_{.}_{t}_{(}_{g}S_{M}_{i}_{Q}_{u}_{o}e_{a}_{F}_{r}_{n}s_{a}_{p}_{I}_{C}s_{)}_{t}i_{n}_{i}_{o}o_{o}_{e}_{m}n_{n}_{w}_{p}a_{l}n_{Q}_{e}d_{t}_{o}_{e}D_{S}^{g}R_{f}^{N}_{l}B_{o}^{B}_{w}(s_{1})_{t}_{6}_{o}_{.}e_{.}_{D}_{e}s_{U}t_{x}_{L}a_{P}_{i}_{s}b_{P}_{t}l_{D}_{i}_{a}i_{n}s_{c}_{a}h_{g}_{k}_{t}e_{a}_{e}_{D}d_{t}_{(}_{R}_{Q}_{(}_{Q}_{B}_{F}_{F}_{I}_{)}_{I}_{)}^{U}^{P}^{F}^{A}^{M}^{F}]
...
![](media_svg/image139.svg) [公式≈: _{4}_{.}_{N}_{e}_{w}_{D}_{R}^{U}_{B}^{E}_{e}_{s}_{5}_{t}_{a}_{.}_{b}_{R}_{l}_{i}_{R}_{s}_{3}_{h}_{C}_{.}_{e}_{R}_{R}_{d}_{7}_{e}_{R}_{.}_{c}_{C}_{U}_{o}_{R}_{n}_{P}_{f}_{e}_{i}_{D}_{c}_{g}_{o}_{a}_{u}_{n}_{t}_{r}_{a}_{f}_{a}_{i}_{t}_{(}_{g}_{i}_{Q}_{u}_{o}_{F}_{r}_{n}_{a}_{I}_{C}_{)}_{t}_{i}_{o}_{o}_{m}_{2}_{n}_{.}_{p}_{S}_{l}^{0}_{e}_{e}^{.}_{t}_{t}_{e}^{P}_{u}^{g}^{D}_{p}^{N}^{U}_{n}^{B}_{e}^{S}_{w}^{e}1^{s}._{D}^{s}P_{6}^{i}_{R}^{o}_{.}D_{B}^{n}_{P}_{7}U_{.}_{D}^{a}_{U}^{n}S_{U}^{d}_{P}E_{S}^{D}S_{D}_{E}S^{R}_{a}I_{S}_{t}^{B}O_{a}_{S}^{(}_{I}N^{s}_{(}_{O}_{Q}^{)}R^{e}_{N}_{F}^{s}E_{I}_{)}^{t}_{R}^{a}S_{E}^{b}O^{l}_{S}^{i}U^{s}_{O}^{h}R_{U}^{e}^{U}C^{d}^{P}_{R}E^{F}_{C}M_{E}O_{M}D_{O}I_{D}FY_{I}_{F}R_{Y}E_{R}Q_{E}U_{S}E_{P}S_{O}T_{N}(_{S}Q_{E}FI)^{A}^{M}^{F}]
...
![](media_svg/image140.svg) [公式≈: ^{4}^{.}^{M}^{a}^{p}^{p}^{i}^{n}^{g}^{U}^{r}^{u}^{E}^{l}^{e}^{s}^{5}^{.}^{u}^{R}^{p}^{d}^{R}^{3}^{a}^{C}^{.}^{t}^{e}^{R}^{R}^{d}^{e}^{R}^{c}^{C}^{o}^{R}^{n}^{f}^{e}^{i}^{c}^{g}^{o}^{u}^{n}^{r}^{f}^{a}^{i}^{t}^{g}^{i}^{u}^{o}^{2}^{r}^{n}^{.}^{a}^{C}^{R}^{t}^{i}^{o}^{e}^{o}^{m}^{l}^{0}^{n}^{e}^{.}^{p}^{a}^{P}^{l}^{s}^{e}^{e}^{D}^{t}^{e}^{U}^{Q}^{g}^{o}^{S}^{N}^{S}^{e}^{B}^{s}^{f}^{l}^{s}^{o}6^{i}^{1}^{w}^{o}.^{.}^{n}P^{P}^{m}D^{a}^{D}^{a}^{n}U^{p}^{U}^{d}^{p}S^{D}^{i}^{S}^{n}E^{R}^{E}^{g}S^{B}^{S}S^{(}^{S}I^{s}^{I}O^{)}^{O}^{e}N^{N}^{s}^{t}R^{a}^{R}E^{b}^{E}^{l}S^{i}^{S}^{s}O^{h}^{O}U^{e}^{U}^{U}^{d}^{P}R^{R}^{F}C^{C}E^{E}M^{M}O^{O}D^{D}I^{I}F^{F}Y^{Y}R^{R}E^{E}S^{Q}P^{U}O^{E}N^{S}S^{T}E^{A}^{M}^{F}]
...
![](media_svg/image141.svg) [公式≈: _{1}_{.}_{U}_{L}_{p}_{a}_{c}_{k}_{e}_{i}_{t}_{f}_{(}_{n}_{2}_{Q}_{o}_{.}_{F}_{D}_{m}_{I}_{)}_{e}_{a}_{f}^{U}_{a}_{p}_{u}_{p}^{E}_{l}_{i}_{t}_{n}_{D}_{g}_{3}_{.}_{R}_{r}_{5}_{U}_{u}_{B}_{.}_{l}_{s}_{e}_{R}_{e}_{s}_{6}_{R}_{r}_{.}_{D}_{C}_{U}_{a}_{R}_{P}_{t}_{e}_{a}_{D}_{c}_{o}_{o}0_{a}_{v}_{n}._{t}_{e}_{a}_{f}P_{r}_{i}_{(}_{g}D_{D}_{Q}_{u}U_{R}_{F}_{r}_{a}_{B}_{I}S_{)}_{t}e_{i}_{(}_{o}_{Q}s_{n}s_{F}io_{I}_{)}n^{g}a^{N}n^{B}dD_{4}_{.}R_{P}B_{D}_{6}(s_{U}_{.})_{U}_{D}e_{P}s_{a}t_{t}_{D}a_{a}b_{a}_{T}l_{t}i_{a}s_{u}h_{n}_{(}e_{Q}_{n}d_{e}_{F}_{l}_{I}_{)}_{(}_{Q}_{F}_{I}_{)}^{U}^{P}^{F}^{A}^{M}^{F}]

...
| Turbo 内部交织器 | TS 36.212 Rel-19 `36212-j30` §5.1.3.2.3，Table 5.1.3-3 | `3GPP_Rel19/processed/TS_36.212_36212-j30` | 已重建：T3.3 与 T3.2 共用 TS 36.212 Table 5.1.3-3 协议原文截图（188 组 `i/K/f1/f2` 参数）；T6.4 仍需精读交织地址生成。 |
